...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Actor', 'model/Actors', 'model/Address', 'model/BlogCategory', 'model/BlogCategoryLists', 'model/BlogPage', 'model/BlogPageLists', 'model/CMSCategoriesLists', 'model/CMSCategory', 'model/CMSPage', 'model/CMSPageLists', 'model/Cart', 'model/CartBody', 'model/CartRule', 'model/CartRuleRestrictionGroup', 'model/CartRuleRestrictionGroupItem', 'model/CartRules', 'model/Carts', 'model/Categories', 'model/Category', 'model/CategoryImages', 'model/Countries', 'model/Country', 'model/Currencies', 'model/Currency', 'model/Customer', 'model/CustomerCreateRequest', 'model/CustomerCurrentViews', 'model/CustomerId', 'model/CustomerThread', 'model/CustomerThread1', 'model/CustomerVideoStat', 'model/CustomerVideoStats', 'model/Customers', 'model/Director', 'model/Director1', 'model/DownloadUrl', 'model/Extract', 'model/Feature', 'model/FeatureValue', 'model/Features', 'model/Gender', 'model/Genders', 'model/Geoloc', 'model/Geolocs', 'model/Group', 'model/Groups', 'model/I18nField', 'model/Image', 'model/Language', 'model/Languages', 'model/MarlinToken', 'model/MediaFile', 'model/MediaFiles', 'model/MediaSource', 'model/MediaSources', 'model/OAuthToken', 'model/Order', 'model/OrderHistories', 'model/OrderHistory', 'model/OrderState', 'model/OrderStates', 'model/Orders', 'model/Pagination', 'model/PaymentArguments', 'model/PaymentModule', 'model/PaymentModules', 'model/PaymentUrl', 'model/PlayerConfiguration', 'model/Product', 'model/ProductAccess', 'model/ProductAttribute', 'model/ProductAttributeCreateRequest', 'model/ProductAttributeUpdateRequest', 'model/ProductAttributesResponse', 'model/ProductExtractsResponse', 'model/ProductImagesResponse', 'model/Products', 'model/Products1', 'model/Screenshot', 'model/SessionVideoStat', 'model/SessionVideoStats', 'model/Subscription', 'model/SubscriptionAccesses', 'model/Subscriptions', 'model/Subtitle', 'model/Subtitles', 'model/Tag', 'model/Task', 'model/TaskCreateRequest', 'model/TaskFactory', 'model/Video', 'model/VideoFreeAccess', 'model/VideoStat', 'model/VideoStats', 'model/VideoUrl', 'model/VideoViews', 'model/Videos', 'model/WidgetFooterMenu', 'model/WidgetFooterMenus', 'model/WidgetSlider', 'model/WidgetSliders', 'model/WidgetTopMenu', 'model/WidgetTopMenus', 'api/AccessesApi', 'api/ActorsApi', 'api/AddressApi', 'api/AttributesApi', 'api/BlogCategoriesApi', 'api/BlogPagesApi', 'api/BookmarksApi', 'api/CMSCategoriesApi', 'api/CMSPagesApi', 'api/CartRulesApi', 'api/CartsApi', 'api/CategoriesApi', 'api/CountriesApi', 'api/CurrenciesApi', 'api/CustomerThreadsApi', 'api/CustomersApi', 'api/DirectorsApi', 'api/ExtractsApi', 'api/FacebookApi', 'api/FeatureValuesApi', 'api/FeaturesApi', 'api/GendersApi', 'api/GeolocationsApi', 'api/GroupsApi', 'api/ImagesApi', 'api/LanguagesApi', 'api/ManufacturersApi', 'api/MediaFilesApi', 'api/MediaSourcesApi', 'api/OAuthApi', 'api/OrderHistoriesApi', 'api/OrderStatesApi', 'api/OrdersApi', 'api/PaymentModulesApi', 'api/PlayerApi', 'api/ProductAccessesApi', 'api/ProductsApi', 'api/StatsApi', 'api/SubscriptionsApi', 'api/SubtitlesApi', 'api/SuppliersApi', 'api/TasksApi', 'api/VideosApi', 'api/WidgetsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Actor'), require('./model/Actors'), require('./model/Address'), require('./model/BlogCategory'), require('./model/BlogCategoryLists'), require('./model/BlogPage'), require('./model/BlogPageLists'), require('./model/CMSCategoriesLists'), require('./model/CMSCategory'), require('./model/CMSPage'), require('./model/CMSPageLists'), require('./model/Cart'), require('./model/CartBody'), require('./model/CartRule'), require('./model/CartRuleRestrictionGroup'), require('./model/CartRuleRestrictionGroupItem'), require('./model/CartRules'), require('./model/Carts'), require('./model/Categories'), require('./model/Category'), require('./model/CategoryImages'), require('./model/Countries'), require('./model/Country'), require('./model/Currencies'), require('./model/Currency'), require('./model/Customer'), require('./model/CustomerCreateRequest'), require('./model/CustomerCurrentViews'), require('./model/CustomerId'), require('./model/CustomerThread'), require('./model/CustomerThread1'), require('./model/CustomerVideoStat'), require('./model/CustomerVideoStats'), require('./model/Customers'), require('./model/Director'), require('./model/Director1'), require('./model/DownloadUrl'), require('./model/Extract'), require('./model/Feature'), require('./model/FeatureValue'), require('./model/Features'), require('./model/Gender'), require('./model/Genders'), require('./model/Geoloc'), require('./model/Geolocs'), require('./model/Group'), require('./model/Groups'), require('./model/I18nField'), require('./model/Image'), require('./model/Language'), require('./model/Languages'), require('./model/MarlinToken'), require('./model/MediaFile'), require('./model/MediaFiles'), require('./model/MediaSource'), require('./model/MediaSources'), require('./model/OAuthToken'), require('./model/Order'), require('./model/OrderHistories'), require('./model/OrderHistory'), require('./model/OrderState'), require('./model/OrderStates'), require('./model/Orders'), require('./model/Pagination'), require('./model/PaymentArguments'), require('./model/PaymentModule'), require('./model/PaymentModules'), require('./model/PaymentUrl'), require('./model/PlayerConfiguration'), require('./model/Product'), require('./model/ProductAccess'), require('./model/ProductAttribute'), require('./model/ProductAttributeCreateRequest'), require('./model/ProductAttributeUpdateRequest'), require('./model/ProductAttributesResponse'), require('./model/ProductExtractsResponse'), require('./model/ProductImagesResponse'), require('./model/Products'), require('./model/Products1'), require('./model/Screenshot'), require('./model/SessionVideoStat'), require('./model/SessionVideoStats'), require('./model/Subscription'), require('./model/SubscriptionAccesses'), require('./model/Subscriptions'), require('./model/Subtitle'), require('./model/Subtitles'), require('./model/Tag'), require('./model/Task'), require('./model/TaskCreateRequest'), require('./model/TaskFactory'), require('./model/Video'), require('./model/VideoFreeAccess'), require('./model/VideoStat'), require('./model/VideoStats'), require('./model/VideoUrl'), require('./model/VideoViews'), require('./model/Videos'), require('./model/WidgetFooterMenu'), require('./model/WidgetFooterMenus'), require('./model/WidgetSlider'), require('./model/WidgetSliders'), require('./model/WidgetTopMenu'), require('./model/WidgetTopMenus'), require('./api/AccessesApi'), require('./api/ActorsApi'), require('./api/AddressApi'), require('./api/AttributesApi'), require('./api/BlogCategoriesApi'), require('./api/BlogPagesApi'), require('./api/BookmarksApi'), require('./api/CMSCategoriesApi'), require('./api/CMSPagesApi'), require('./api/CartRulesApi'), require('./api/CartsApi'), require('./api/CategoriesApi'), require('./api/CountriesApi'), require('./api/CurrenciesApi'), require('./api/CustomerThreadsApi'), require('./api/CustomersApi'), require('./api/DirectorsApi'), require('./api/ExtractsApi'), require('./api/FacebookApi'), require('./api/FeatureValuesApi'), require('./api/FeaturesApi'), require('./api/GendersApi'), require('./api/GeolocationsApi'), require('./api/GroupsApi'), require('./api/ImagesApi'), require('./api/LanguagesApi'), require('./api/ManufacturersApi'), require('./api/MediaFilesApi'), require('./api/MediaSourcesApi'), require('./api/OAuthApi'), require('./api/OrderHistoriesApi'), require('./api/OrderStatesApi'), require('./api/OrdersApi'), require('./api/PaymentModulesApi'), require('./api/PlayerApi'), require('./api/ProductAccessesApi'), require('./api/ProductsApi'), require('./api/StatsApi'), require('./api/SubscriptionsApi'), require('./api/SubtitlesApi'), require('./api/SuppliersApi'), require('./api/TasksApi'), require('./api/VideosApi'), require('./api/WidgetsApi'));
  }
}(function(ApiClient, Actor, Actors, Address, BlogCategory, BlogCategoryLists, BlogPage, BlogPageLists, CMSCategoriesLists, CMSCategory, CMSPage, CMSPageLists, Cart, CartBody, CartRule, CartRuleRestrictionGroup, CartRuleRestrictionGroupItem, CartRules, Carts, Categories, Category, CategoryImages, Countries, Country, Currencies, Currency, Customer, CustomerCreateRequest, CustomerCurrentViews, CustomerId, CustomerThread, CustomerThread1, CustomerVideoStat, CustomerVideoStats, Customers, Director, Director1, DownloadUrl, Extract, Feature, FeatureValue, Features, Gender, Genders, Geoloc, Geolocs, Group, Groups, I18nField, Image, Language, Languages, MarlinToken, MediaFile, MediaFiles, MediaSource, MediaSources, OAuthToken, Order, OrderHistories, OrderHistory, OrderState, OrderStates, Orders, Pagination, PaymentArguments, PaymentModule, PaymentModules, PaymentUrl, PlayerConfiguration, Product, ProductAccess, ProductAttribute, ProductAttributeCreateRequest, ProductAttributeUpdateRequest, ProductAttributesResponse, ProductExtractsResponse, ProductImagesResponse, Products, Products1, Screenshot, SessionVideoStat, SessionVideoStats, Subscription, SubscriptionAccesses, Subscriptions, Subtitle, Subtitles, Tag, Task, TaskCreateRequest, TaskFactory, Video, VideoFreeAccess, VideoStat, VideoStats, VideoUrl, VideoViews, Videos, WidgetFooterMenu, WidgetFooterMenus, WidgetSlider, WidgetSliders, WidgetTopMenu, WidgetTopMenus, AccessesApi, ActorsApi, AddressApi, AttributesApi, BlogCategoriesApi, BlogPagesApi, BookmarksApi, CMSCategoriesApi, CMSPagesApi, CartRulesApi, CartsApi, CategoriesApi, CountriesApi, CurrenciesApi, CustomerThreadsApi, CustomersApi, DirectorsApi, ExtractsApi, FacebookApi, FeatureValuesApi, FeaturesApi, GendersApi, GeolocationsApi, GroupsApi, ImagesApi, LanguagesApi, ManufacturersApi, MediaFilesApi, MediaSourcesApi, OAuthApi, OrderHistoriesApi, OrderStatesApi, OrdersApi, PaymentModulesApi, PlayerApi, ProductAccessesApi, ProductsApi, StatsApi, SubscriptionsApi, SubtitlesApi, SuppliersApi, TasksApi, VideosApi, WidgetsApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The CustomerVideoStat model constructor.
     * @property {module:model/CustomerVideoStat}
     */
    ...
    Languages: Languages,
    /**
     * The MarlinToken model constructor.
     * @property {module:model/MarlinToken}
     */
