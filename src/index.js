...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Actor', 'model/Actor1', 'model/Actor2', 'model/Actors', 'model/Address', 'model/Address1', 'model/Analytic', 'model/Analytics', 'model/BlogCategory', 'model/BlogCategoryLists', 'model/BlogPage', 'model/BlogPageLists', 'model/Bonus', 'model/CMSCategoriesLists', 'model/CMSCategory', 'model/CMSPage', 'model/CMSPageLists', 'model/Cart', 'model/Cart1', 'model/Cart2', 'model/CartIDList', 'model/CartPrice', 'model/CartProduct', 'model/CartRule', 'model/CartRuleRestrictionGroup', 'model/CartRuleRestrictionGroupItem', 'model/CartRules', 'model/Carts', 'model/Categories', 'model/Category', 'model/CategoryDirectorsResponse', 'model/CategoryImagesResponse', 'model/Configuration', 'model/ConfigurationList', 'model/Contact', 'model/Contacts', 'model/Countries', 'model/Country', 'model/CreateExtractSubtitleRequest', 'model/CreateVideoSubtitleRequest', 'model/CredentialsValidation', 'model/Currencies', 'model/Currency', 'model/Customer', 'model/CustomerCreateRequest', 'model/CustomerCurrentViews', 'model/CustomerGroupVideoStats', 'model/CustomerGroupVideoStats1', 'model/CustomerId', 'model/CustomerVideoStats', 'model/CustomerVideoStats1', 'model/Customers', 'model/Device', 'model/DeviceList', 'model/Director', 'model/Director1', 'model/Director2', 'model/DownloadInformations', 'model/Employee', 'model/Employees', 'model/Extract', 'model/ExtractAccessInfo', 'model/ExtractIDList', 'model/Feature', 'model/FeatureValue', 'model/Features', 'model/FreeGift', 'model/FreeGift1', 'model/Gender', 'model/Genders', 'model/Geoloc', 'model/GeolocSettings', 'model/Geolocs', 'model/Gift', 'model/Gift1', 'model/Gift2', 'model/GiftToken', 'model/Gifts', 'model/Gifts1', 'model/GoogleAnalytics', 'model/Group', 'model/GroupCreateRequest', 'model/Groups', 'model/I18nField', 'model/IPCoordinates', 'model/IPLocation', 'model/Image', 'model/ImageType', 'model/Language', 'model/Languages', 'model/LogoSettings', 'model/MediaFile', 'model/MediaFiles', 'model/MediaSource', 'model/MediaSources', 'model/OAuthToken', 'model/Order', 'model/OrderHistories', 'model/OrderHistory', 'model/OrderState', 'model/OrderStates', 'model/Orders', 'model/Page', 'model/PageLists', 'model/Pagination', 'model/PaymentArguments', 'model/PaymentDetails', 'model/PaymentDetails1', 'model/PaymentMethods', 'model/PaymentModule', 'model/PaymentModules', 'model/PaymentToken', 'model/PaymentToken1', 'model/PaymentUrl', 'model/PlatformAccessInfo', 'model/Player', 'model/PlayerConfiguration', 'model/Playlist', 'model/PlaylistUpdate', 'model/Playlists', 'model/PrepaymentBalance', 'model/PrepaymentBonus', 'model/PrepaymentBonus1', 'model/PrepaymentBonusAmount', 'model/PrepaymentBonusIDList', 'model/PrepaymentOperation', 'model/PrepaymentOperationAmount', 'model/PrepaymentOperationIDList', 'model/PrepaymentOperations', 'model/PrepaymentRecharge', 'model/PrepaymentRecharges', 'model/Product', 'model/ProductAccess', 'model/ProductAccessInfo', 'model/ProductAttribute', 'model/ProductAttributeCreateRequest', 'model/ProductAttributeCreateRequest1', 'model/ProductAttributesResponse', 'model/ProductCategories', 'model/ProductIDList', 'model/ProductIDList1', 'model/ProductPrice', 'model/ProductPriceAttributes', 'model/Products', 'model/Products1', 'model/Promotion', 'model/RegistrationField', 'model/RegistrationFields', 'model/SessionVideoStat', 'model/SessionVideoStats', 'model/SocialSettings', 'model/Subscription', 'model/SubscriptionAccesses', 'model/Subscriptions', 'model/Subtitle', 'model/SubtitleFile', 'model/SubtitleFiles', 'model/Support', 'model/SupportMessage', 'model/Tag', 'model/Task', 'model/TaskCreateRequest', 'model/TaxPrice', 'model/TaxRule', 'model/TaxRules', 'model/Token', 'model/Video', 'model/VideoAccessInfo', 'model/VideoCategory', 'model/VideoFreeAccess', 'model/VideoGroup', 'model/VideoGroup1', 'model/VideoIDList', 'model/VideoIDList1', 'model/VideoStat', 'model/VideoStats', 'model/VideoSubtitlesResponse', 'model/VideoViews', 'model/Videos', 'model/Videos1', 'model/Videos2', 'model/WidgetFooterMenu', 'model/WidgetFooterMenus', 'model/WidgetHomeRail', 'model/WidgetHomeRails', 'model/WidgetHookPhrase', 'model/WidgetHookPhrases', 'model/WidgetSlider', 'model/WidgetSliders', 'model/WidgetTopMenu', 'model/WidgetTopMenus', 'api/ActorsApi', 'api/AddressApi', 'api/AttributesApi', 'api/BlogCategoriesApi', 'api/BlogPagesApi', 'api/BookmarksApi', 'api/BundlesApi', 'api/CMSCategoriesApi', 'api/CMSPagesApi', 'api/CartRulesApi', 'api/CartsApi', 'api/CategoriesApi', 'api/CategoryVideosApi', 'api/ConfigurationApi', 'api/CountriesApi', 'api/CurrenciesApi', 'api/CustomersApi', 'api/DevicesApi', 'api/DirectorsApi', 'api/EmployeesApi', 'api/ExtractsApi', 'api/FeatureValuesApi', 'api/FeaturesApi', 'api/FreeGiftsApi', 'api/GendersApi', 'api/GeolocationsApi', 'api/GiftsApi', 'api/GroupsApi', 'api/ImagesApi', 'api/LanguagesApi', 'api/MediaFilesApi', 'api/MediaSourcesApi', 'api/OAuthApi', 'api/OrderHistoriesApi', 'api/OrderStatesApi', 'api/OrdersApi', 'api/PagesApi', 'api/PaymentModulesApi', 'api/PlaylistsApi', 'api/PrepaymentsApi', 'api/ProductAccessesApi', 'api/ProductsApi', 'api/RecommendationsApi', 'api/StatsApi', 'api/SubscriptionsApi', 'api/SubtitlesApi', 'api/SupportApi', 'api/TasksApi', 'api/TaxRulesApi', 'api/VideoGroupsApi', 'api/VideosApi', 'api/WidgetsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Actor'), require('./model/Actor1'), require('./model/Actor2'), require('./model/Actors'), require('./model/Address'), require('./model/Address1'), require('./model/Analytic'), require('./model/Analytics'), require('./model/BlogCategory'), require('./model/BlogCategoryLists'), require('./model/BlogPage'), require('./model/BlogPageLists'), require('./model/Bonus'), require('./model/CMSCategoriesLists'), require('./model/CMSCategory'), require('./model/CMSPage'), require('./model/CMSPageLists'), require('./model/Cart'), require('./model/Cart1'), require('./model/Cart2'), require('./model/CartIDList'), require('./model/CartPrice'), require('./model/CartProduct'), require('./model/CartRule'), require('./model/CartRuleRestrictionGroup'), require('./model/CartRuleRestrictionGroupItem'), require('./model/CartRules'), require('./model/Carts'), require('./model/Categories'), require('./model/Category'), require('./model/CategoryDirectorsResponse'), require('./model/CategoryImagesResponse'), require('./model/Configuration'), require('./model/ConfigurationList'), require('./model/Contact'), require('./model/Contacts'), require('./model/Countries'), require('./model/Country'), require('./model/CreateExtractSubtitleRequest'), require('./model/CreateVideoSubtitleRequest'), require('./model/CredentialsValidation'), require('./model/Currencies'), require('./model/Currency'), require('./model/Customer'), require('./model/CustomerCreateRequest'), require('./model/CustomerCurrentViews'), require('./model/CustomerGroupVideoStats'), require('./model/CustomerGroupVideoStats1'), require('./model/CustomerId'), require('./model/CustomerVideoStats'), require('./model/CustomerVideoStats1'), require('./model/Customers'), require('./model/Device'), require('./model/DeviceList'), require('./model/Director'), require('./model/Director1'), require('./model/Director2'), require('./model/DownloadInformations'), require('./model/Employee'), require('./model/Employees'), require('./model/Extract'), require('./model/ExtractAccessInfo'), require('./model/ExtractIDList'), require('./model/Feature'), require('./model/FeatureValue'), require('./model/Features'), require('./model/FreeGift'), require('./model/FreeGift1'), require('./model/Gender'), require('./model/Genders'), require('./model/Geoloc'), require('./model/GeolocSettings'), require('./model/Geolocs'), require('./model/Gift'), require('./model/Gift1'), require('./model/Gift2'), require('./model/GiftToken'), require('./model/Gifts'), require('./model/Gifts1'), require('./model/GoogleAnalytics'), require('./model/Group'), require('./model/GroupCreateRequest'), require('./model/Groups'), require('./model/I18nField'), require('./model/IPCoordinates'), require('./model/IPLocation'), require('./model/Image'), require('./model/ImageType'), require('./model/Language'), require('./model/Languages'), require('./model/LogoSettings'), require('./model/MediaFile'), require('./model/MediaFiles'), require('./model/MediaSource'), require('./model/MediaSources'), require('./model/OAuthToken'), require('./model/Order'), require('./model/OrderHistories'), require('./model/OrderHistory'), require('./model/OrderState'), require('./model/OrderStates'), require('./model/Orders'), require('./model/Page'), require('./model/PageLists'), require('./model/Pagination'), require('./model/PaymentArguments'), require('./model/PaymentDetails'), require('./model/PaymentDetails1'), require('./model/PaymentMethods'), require('./model/PaymentModule'), require('./model/PaymentModules'), require('./model/PaymentToken'), require('./model/PaymentToken1'), require('./model/PaymentUrl'), require('./model/PlatformAccessInfo'), require('./model/Player'), require('./model/PlayerConfiguration'), require('./model/Playlist'), require('./model/PlaylistUpdate'), require('./model/Playlists'), require('./model/PrepaymentBalance'), require('./model/PrepaymentBonus'), require('./model/PrepaymentBonus1'), require('./model/PrepaymentBonusAmount'), require('./model/PrepaymentBonusIDList'), require('./model/PrepaymentOperation'), require('./model/PrepaymentOperationAmount'), require('./model/PrepaymentOperationIDList'), require('./model/PrepaymentOperations'), require('./model/PrepaymentRecharge'), require('./model/PrepaymentRecharges'), require('./model/Product'), require('./model/ProductAccess'), require('./model/ProductAccessInfo'), require('./model/ProductAttribute'), require('./model/ProductAttributeCreateRequest'), require('./model/ProductAttributeCreateRequest1'), require('./model/ProductAttributesResponse'), require('./model/ProductCategories'), require('./model/ProductIDList'), require('./model/ProductIDList1'), require('./model/ProductPrice'), require('./model/ProductPriceAttributes'), require('./model/Products'), require('./model/Products1'), require('./model/Promotion'), require('./model/RegistrationField'), require('./model/RegistrationFields'), require('./model/SessionVideoStat'), require('./model/SessionVideoStats'), require('./model/SocialSettings'), require('./model/Subscription'), require('./model/SubscriptionAccesses'), require('./model/Subscriptions'), require('./model/Subtitle'), require('./model/SubtitleFile'), require('./model/SubtitleFiles'), require('./model/Support'), require('./model/SupportMessage'), require('./model/Tag'), require('./model/Task'), require('./model/TaskCreateRequest'), require('./model/TaxPrice'), require('./model/TaxRule'), require('./model/TaxRules'), require('./model/Token'), require('./model/Video'), require('./model/VideoAccessInfo'), require('./model/VideoCategory'), require('./model/VideoFreeAccess'), require('./model/VideoGroup'), require('./model/VideoGroup1'), require('./model/VideoIDList'), require('./model/VideoIDList1'), require('./model/VideoStat'), require('./model/VideoStats'), require('./model/VideoSubtitlesResponse'), require('./model/VideoViews'), require('./model/Videos'), require('./model/Videos1'), require('./model/Videos2'), require('./model/WidgetFooterMenu'), require('./model/WidgetFooterMenus'), require('./model/WidgetHomeRail'), require('./model/WidgetHomeRails'), require('./model/WidgetHookPhrase'), require('./model/WidgetHookPhrases'), require('./model/WidgetSlider'), require('./model/WidgetSliders'), require('./model/WidgetTopMenu'), require('./model/WidgetTopMenus'), require('./api/ActorsApi'), require('./api/AddressApi'), require('./api/AttributesApi'), require('./api/BlogCategoriesApi'), require('./api/BlogPagesApi'), require('./api/BookmarksApi'), require('./api/BundlesApi'), require('./api/CMSCategoriesApi'), require('./api/CMSPagesApi'), require('./api/CartRulesApi'), require('./api/CartsApi'), require('./api/CategoriesApi'), require('./api/CategoryVideosApi'), require('./api/ConfigurationApi'), require('./api/CountriesApi'), require('./api/CurrenciesApi'), require('./api/CustomersApi'), require('./api/DevicesApi'), require('./api/DirectorsApi'), require('./api/EmployeesApi'), require('./api/ExtractsApi'), require('./api/FeatureValuesApi'), require('./api/FeaturesApi'), require('./api/FreeGiftsApi'), require('./api/GendersApi'), require('./api/GeolocationsApi'), require('./api/GiftsApi'), require('./api/GroupsApi'), require('./api/ImagesApi'), require('./api/LanguagesApi'), require('./api/MediaFilesApi'), require('./api/MediaSourcesApi'), require('./api/OAuthApi'), require('./api/OrderHistoriesApi'), require('./api/OrderStatesApi'), require('./api/OrdersApi'), require('./api/PagesApi'), require('./api/PaymentModulesApi'), require('./api/PlaylistsApi'), require('./api/PrepaymentsApi'), require('./api/ProductAccessesApi'), require('./api/ProductsApi'), require('./api/RecommendationsApi'), require('./api/StatsApi'), require('./api/SubscriptionsApi'), require('./api/SubtitlesApi'), require('./api/SupportApi'), require('./api/TasksApi'), require('./api/TaxRulesApi'), require('./api/VideoGroupsApi'), require('./api/VideosApi'), require('./api/WidgetsApi'));
  }
}(function(ApiClient, Actor, Actor1, Actor2, Actors, Address, Address1, Analytic, Analytics, BlogCategory, BlogCategoryLists, BlogPage, BlogPageLists, Bonus, CMSCategoriesLists, CMSCategory, CMSPage, CMSPageLists, Cart, Cart1, Cart2, CartIDList, CartPrice, CartProduct, CartRule, CartRuleRestrictionGroup, CartRuleRestrictionGroupItem, CartRules, Carts, Categories, Category, CategoryDirectorsResponse, CategoryImagesResponse, Configuration, ConfigurationList, Contact, Contacts, Countries, Country, CreateExtractSubtitleRequest, CreateVideoSubtitleRequest, CredentialsValidation, Currencies, Currency, Customer, CustomerCreateRequest, CustomerCurrentViews, CustomerGroupVideoStats, CustomerGroupVideoStats1, CustomerId, CustomerVideoStats, CustomerVideoStats1, Customers, Device, DeviceList, Director, Director1, Director2, DownloadInformations, Employee, Employees, Extract, ExtractAccessInfo, ExtractIDList, Feature, FeatureValue, Features, FreeGift, FreeGift1, Gender, Genders, Geoloc, GeolocSettings, Geolocs, Gift, Gift1, Gift2, GiftToken, Gifts, Gifts1, GoogleAnalytics, Group, GroupCreateRequest, Groups, I18nField, IPCoordinates, IPLocation, Image, ImageType, Language, Languages, LogoSettings, MediaFile, MediaFiles, MediaSource, MediaSources, OAuthToken, Order, OrderHistories, OrderHistory, OrderState, OrderStates, Orders, Page, PageLists, Pagination, PaymentArguments, PaymentDetails, PaymentDetails1, PaymentMethods, PaymentModule, PaymentModules, PaymentToken, PaymentToken1, PaymentUrl, PlatformAccessInfo, Player, PlayerConfiguration, Playlist, PlaylistUpdate, Playlists, PrepaymentBalance, PrepaymentBonus, PrepaymentBonus1, PrepaymentBonusAmount, PrepaymentBonusIDList, PrepaymentOperation, PrepaymentOperationAmount, PrepaymentOperationIDList, PrepaymentOperations, PrepaymentRecharge, PrepaymentRecharges, Product, ProductAccess, ProductAccessInfo, ProductAttribute, ProductAttributeCreateRequest, ProductAttributeCreateRequest1, ProductAttributesResponse, ProductCategories, ProductIDList, ProductIDList1, ProductPrice, ProductPriceAttributes, Products, Products1, Promotion, RegistrationField, RegistrationFields, SessionVideoStat, SessionVideoStats, SocialSettings, Subscription, SubscriptionAccesses, Subscriptions, Subtitle, SubtitleFile, SubtitleFiles, Support, SupportMessage, Tag, Task, TaskCreateRequest, TaxPrice, TaxRule, TaxRules, Token, Video, VideoAccessInfo, VideoCategory, VideoFreeAccess, VideoGroup, VideoGroup1, VideoIDList, VideoIDList1, VideoStat, VideoStats, VideoSubtitlesResponse, VideoViews, Videos, Videos1, Videos2, WidgetFooterMenu, WidgetFooterMenus, WidgetHomeRail, WidgetHomeRails, WidgetHookPhrase, WidgetHookPhrases, WidgetSlider, WidgetSliders, WidgetTopMenu, WidgetTopMenus, ActorsApi, AddressApi, AttributesApi, BlogCategoriesApi, BlogPagesApi, BookmarksApi, BundlesApi, CMSCategoriesApi, CMSPagesApi, CartRulesApi, CartsApi, CategoriesApi, CategoryVideosApi, ConfigurationApi, CountriesApi, CurrenciesApi, CustomersApi, DevicesApi, DirectorsApi, EmployeesApi, ExtractsApi, FeatureValuesApi, FeaturesApi, FreeGiftsApi, GendersApi, GeolocationsApi, GiftsApi, GroupsApi, ImagesApi, LanguagesApi, MediaFilesApi, MediaSourcesApi, OAuthApi, OrderHistoriesApi, OrderStatesApi, OrdersApi, PagesApi, PaymentModulesApi, PlaylistsApi, PrepaymentsApi, ProductAccessesApi, ProductsApi, RecommendationsApi, StatsApi, SubscriptionsApi, SubtitlesApi, SupportApi, TasksApi, TaxRulesApi, VideoGroupsApi, VideosApi, WidgetsApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The WidgetHomeRails model constructor.
     * @property {module:model/WidgetHomeRails}
     */
