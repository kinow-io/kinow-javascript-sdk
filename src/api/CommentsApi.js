...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateCommentRequest', 'model/ProductCommentResponse', 'model/CommentResponse', 'model/CommentListResponse', 'model/CustomerCommentListResponse1', 'model/ProductCommentListResponse1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateCommentRequest'), require('../model/ProductCommentResponse'), require('../model/CommentResponse'), require('../model/CommentListResponse'), require('../model/CustomerCommentListResponse1'), require('../model/ProductCommentListResponse1'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CommentsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CreateCommentRequest, root.KinowJavascriptSdk.ProductCommentResponse, root.KinowJavascriptSdk.CommentResponse, root.KinowJavascriptSdk.CommentListResponse, root.KinowJavascriptSdk.CustomerCommentListResponse1, root.KinowJavascriptSdk.ProductCommentListResponse1);
  }
}(this, function(ApiClient, CreateCommentRequest, ProductCommentResponse, CommentResponse, CommentListResponse, CustomerCommentListResponse1, ProductCommentListResponse1) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CommentListResponse} and HTTP response
     */
    this.getCommentsWithHttpInfo = function(opts) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = CommentListResponse;
     ...
     * @param {String} opts.sortBy Sort by this attribute (id by default)
     * @param {module:model/String} opts.sortDirection Sorting direction (asc by default)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CommentListResponse}
     */
