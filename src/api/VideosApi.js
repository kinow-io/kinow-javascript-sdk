...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Video', 'model/Subscriptions', 'model/DownloadUrl', 'model/MarlinToken', 'model/VideoUrl', 'model/Features', 'model/Geolocs', 'model/PlayerConfiguration', 'model/VideoSubtitlesResponse', 'model/VideoViews', 'model/Videos'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Video'), require('../model/Subscriptions'), require('../model/DownloadUrl'), require('../model/MarlinToken'), require('../model/VideoUrl'), require('../model/Features'), require('../model/Geolocs'), require('../model/PlayerConfiguration'), require('../model/VideoSubtitlesResponse'), require('../model/VideoViews'), require('../model/Videos'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.VideosApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Video, root.KinowJavascriptSdk.Subscriptions, root.KinowJavascriptSdk.DownloadUrl, root.KinowJavascriptSdk.MarlinToken, root.KinowJavascriptSdk.VideoUrl, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.PlayerConfiguration, root.KinowJavascriptSdk.VideoSubtitlesResponse, root.KinowJavascriptSdk.VideoViews, root.KinowJavascriptSdk.Videos);
  }
}(this, function(ApiClient, Video, Subscriptions, DownloadUrl, MarlinToken, VideoUrl, Features, Geolocs, PlayerConfiguration, VideoSubtitlesResponse, VideoViews, Videos) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} idImage ID of the image to attach
    ...
    /**
     * Delete video
     * @param {Integer} videoId ID of the video to delete
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
     ...
     */
    this.getDownloadUrlWithHttpInfo = function(customerId, videoId) {
      var postBody = null;

      // verify the required parameter 'customerId' is set
      if (customerId === undefined || customerId === null) {
        throw new Error("Missing the required parameter 'customerId' when calling getDownloadUrl");
      }

      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling getDownloadUrl");
      }
      ...
      return this.apiClient.callApi(
        '/customers/{customer_id}/videos/{video_id}/download', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    this.getDownloadUrl = function(customerId, videoId) {
      return this.getDownloadUrlWithHttpInfo(customerId, videoId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Integer} customerId Id of the customer to fetch
     * @param {Integer} videoId Id of the video to fetch
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MarlinToken} and HTTP response
     */
    this.getMarlinTokenWithHttpInfo = function(customerId, videoId) {
      var postBody = null;

      // verify the required parameter 'customerId' is set
      if (customerId === undefined || customerId === null) {
        throw new Error("Missing the required parameter 'customerId' when calling getMarlinToken");
      }

      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling getMarlinToken");
      }
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = MarlinToken;

      return this.apiClient.callApi(
        '/customers/{customer_id}/videos/{video_id}/marlin', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @param {Integer} customerId Id of the customer to fetch
     * @param {Integer} videoId Id of the video to fetch
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/MarlinToken}
     */
    this.getMarlinToken = function(customerId, videoId) {
      return this.getMarlinTokenWithHttpInfo(customerId, videoId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/VideoUrl} and HTTP response
     */
    this.getPlayerIframeWithHttpInfo = function(videoId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling getPlayerIframe");
      }
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = VideoUrl;

      return this.apiClient.callApi(
        '/videos/{video_id}/player-iframe', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Integer} opts.customerId Id of the customer to fetch
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/VideoUrl}
     */
    this.getPlayerIframe = function(videoId, opts) {
      return this.getPlayerIframeWithHttpInfo(videoId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/VideoUrl} and HTTP response
     */
    this.getPlayerUrlWithHttpInfo = function(customerId, videoId) {
      var postBody = null;

      // verify the required parameter 'customerId' is set
      if (customerId === undefined || customerId === null) {
        throw new Error("Missing the required parameter 'customerId' when calling getPlayerUrl");
      }

      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling getPlayerUrl");
      }
      ...
      return this.apiClient.callApi(
        '/customers/{customer_id}/videos/{video_id}/player', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/VideoUrl}
     */
    this.getPlayerUrl = function(customerId, videoId) {
      return this.getPlayerUrlWithHttpInfo(customerId, videoId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.getVideoGeolocation_0WithHttpInfo = function(videoId, ipAddress, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling getVideoGeolocation_0");
      }

      // verify the required parameter 'ipAddress' is set
      if (ipAddress === undefined || ipAddress === null) {
        throw new Error("Missing the required parameter 'ipAddress' when calling getVideoGeolocation_0");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.getVideoGeolocation_0 = function(videoId, ipAddress, opts) {
      return this.getVideoGeolocation_0WithHttpInfo(videoId, ipAddress, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.getVideoPlayerUrlWithHttpInfo = function(videoId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling getVideoPlayerUrl");
      }
     ...
     */
    this.getVideoPlayerUrl = function(videoId, opts) {
      return this.getVideoPlayerUrlWithHttpInfo(videoId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    /**
     * Update video
     * @param {Integer} videoId ID of the video to update
     * @param {module:model/Video} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Video} and HTTP response
     */
