...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/VideoResponse', 'model/CreateVideoRequest', 'model/SubtitleResponse', 'model/CreateVideoSubtitleRequest', 'model/VideoIDList', 'model/VideoAccessInfo', 'model/SubscriptionListResponse', 'model/Bonus', 'model/ImageResponse', 'model/DownloadInformations', 'model/Features', 'model/GeolocationListResponse', 'model/PlayerConfiguration', 'model/ExtractSubtitlesResponse', 'model/VideoViews', 'model/VideoListResponse', 'model/ProductVideoListResponse', 'model/UpdateVideoRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/VideoResponse'), require('../model/CreateVideoRequest'), require('../model/SubtitleResponse'), require('../model/CreateVideoSubtitleRequest'), require('../model/VideoIDList'), require('../model/VideoAccessInfo'), require('../model/SubscriptionListResponse'), require('../model/Bonus'), require('../model/ImageResponse'), require('../model/DownloadInformations'), require('../model/Features'), require('../model/GeolocationListResponse'), require('../model/PlayerConfiguration'), require('../model/ExtractSubtitlesResponse'), require('../model/VideoViews'), require('../model/VideoListResponse'), require('../model/ProductVideoListResponse'), require('../model/UpdateVideoRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.VideosApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.VideoResponse, root.KinowJavascriptSdk.CreateVideoRequest, root.KinowJavascriptSdk.SubtitleResponse, root.KinowJavascriptSdk.CreateVideoSubtitleRequest, root.KinowJavascriptSdk.VideoIDList, root.KinowJavascriptSdk.VideoAccessInfo, root.KinowJavascriptSdk.SubscriptionListResponse, root.KinowJavascriptSdk.Bonus, root.KinowJavascriptSdk.ImageResponse, root.KinowJavascriptSdk.DownloadInformations, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.GeolocationListResponse, root.KinowJavascriptSdk.PlayerConfiguration, root.KinowJavascriptSdk.ExtractSubtitlesResponse, root.KinowJavascriptSdk.VideoViews, root.KinowJavascriptSdk.VideoListResponse, root.KinowJavascriptSdk.ProductVideoListResponse, root.KinowJavascriptSdk.UpdateVideoRequest);
  }
}(this, function(ApiClient, VideoResponse, CreateVideoRequest, SubtitleResponse, CreateVideoSubtitleRequest, VideoIDList, VideoAccessInfo, SubscriptionListResponse, Bonus, ImageResponse, DownloadInformations, Features, GeolocationListResponse, PlayerConfiguration, ExtractSubtitlesResponse, VideoViews, VideoListResponse, ProductVideoListResponse, UpdateVideoRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Boolean} opts.forceReload Force seekbar to the begining and ignore viewing resume
