...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Subtitle', 'model/CreateVideoSubtitleRequest', 'model/Video', 'model/Player', 'model/VideoSubtitlesResponse', 'model/VideoIDList', 'model/VideoAccessInfo', 'model/VideoIDList1', 'model/SessionVideoStats', 'model/Subscriptions', 'model/Bonus', 'model/Image', 'model/DownloadInformations', 'model/Features', 'model/Geolocs', 'model/Player1', 'model/VideoViews', 'model/Videos2', 'model/Videos'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Subtitle'), require('../model/CreateVideoSubtitleRequest'), require('../model/Video'), require('../model/Player'), require('../model/VideoSubtitlesResponse'), require('../model/VideoIDList'), require('../model/VideoAccessInfo'), require('../model/VideoIDList1'), require('../model/SessionVideoStats'), require('../model/Subscriptions'), require('../model/Bonus'), require('../model/Image'), require('../model/DownloadInformations'), require('../model/Features'), require('../model/Geolocs'), require('../model/Player1'), require('../model/VideoViews'), require('../model/Videos2'), require('../model/Videos'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.VideosApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Subtitle, root.KinowJavascriptSdk.CreateVideoSubtitleRequest, root.KinowJavascriptSdk.Video, root.KinowJavascriptSdk.Player, root.KinowJavascriptSdk.VideoSubtitlesResponse, root.KinowJavascriptSdk.VideoIDList, root.KinowJavascriptSdk.VideoAccessInfo, root.KinowJavascriptSdk.VideoIDList1, root.KinowJavascriptSdk.SessionVideoStats, root.KinowJavascriptSdk.Subscriptions, root.KinowJavascriptSdk.Bonus, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.DownloadInformations, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.Player1, root.KinowJavascriptSdk.VideoViews, root.KinowJavascriptSdk.Videos2, root.KinowJavascriptSdk.Videos);
  }
}(this, function(ApiClient, Subtitle, CreateVideoSubtitleRequest, Video, Player, VideoSubtitlesResponse, VideoIDList, VideoAccessInfo, VideoIDList1, SessionVideoStats, Subscriptions, Bonus, Image, DownloadInformations, Features, Geolocs, Player1, VideoViews, Videos2, Videos) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.createSubtitleWithHttpInfo = function(videoId, body) {
      var postBody = body;

      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling createSubtitle");
      }
     ...
     */
    this.createSubtitle = function(videoId, body) {
      return this.createSubtitleWithHttpInfo(videoId, body)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     * @param {Integer} opts.countryId Country ID to use in video analytics
     * @param {String} opts.ipAddress IP address
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Player1} and HTTP response
     */
     ...
     * @param {Integer} opts.countryId Country ID to use in video analytics
     * @param {String} opts.ipAddress IP address
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Player1}
     */
