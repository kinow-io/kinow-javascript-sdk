...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Subtitle', 'model/CreateVideoSubtitleRequest', 'model/Video', 'model/VideoIDList', 'model/VideoAccessInfo', 'model/Subscriptions', 'model/Bonus', 'model/Image', 'model/DownloadInformations', 'model/Features', 'model/Geolocs', 'model/Player1', 'model/VideoSubtitlesResponse', 'model/VideoViews', 'model/Videos2'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Subtitle'), require('../model/CreateVideoSubtitleRequest'), require('../model/Video'), require('../model/VideoIDList'), require('../model/VideoAccessInfo'), require('../model/Subscriptions'), require('../model/Bonus'), require('../model/Image'), require('../model/DownloadInformations'), require('../model/Features'), require('../model/Geolocs'), require('../model/Player1'), require('../model/VideoSubtitlesResponse'), require('../model/VideoViews'), require('../model/Videos2'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.VideosApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Subtitle, root.KinowJavascriptSdk.CreateVideoSubtitleRequest, root.KinowJavascriptSdk.Video, root.KinowJavascriptSdk.VideoIDList, root.KinowJavascriptSdk.VideoAccessInfo, root.KinowJavascriptSdk.Subscriptions, root.KinowJavascriptSdk.Bonus, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.DownloadInformations, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.Player1, root.KinowJavascriptSdk.VideoSubtitlesResponse, root.KinowJavascriptSdk.VideoViews, root.KinowJavascriptSdk.Videos2);
  }
}(this, function(ApiClient, Subtitle, CreateVideoSubtitleRequest, Video, VideoIDList, VideoAccessInfo, Subscriptions, Bonus, Image, DownloadInformations, Features, Geolocs, Player1, VideoSubtitlesResponse, VideoViews, Videos2) {
  'use strict';
