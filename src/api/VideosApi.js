...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Video', 'model/Player', 'model/VideoSubtitlesResponse', 'model/VideoIDList', 'model/VideoAccessInfo', 'model/Subscriptions', 'model/Bonus', 'model/Image', 'model/DownloadInformations', 'model/Features', 'model/Geolocs', 'model/VideoViews', 'model/Videos2', 'model/Videos'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Video'), require('../model/Player'), require('../model/VideoSubtitlesResponse'), require('../model/VideoIDList'), require('../model/VideoAccessInfo'), require('../model/Subscriptions'), require('../model/Bonus'), require('../model/Image'), require('../model/DownloadInformations'), require('../model/Features'), require('../model/Geolocs'), require('../model/VideoViews'), require('../model/Videos2'), require('../model/Videos'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.VideosApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Video, root.KinowJavascriptSdk.Player, root.KinowJavascriptSdk.VideoSubtitlesResponse, root.KinowJavascriptSdk.VideoIDList, root.KinowJavascriptSdk.VideoAccessInfo, root.KinowJavascriptSdk.Subscriptions, root.KinowJavascriptSdk.Bonus, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.DownloadInformations, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.VideoViews, root.KinowJavascriptSdk.Videos2, root.KinowJavascriptSdk.Videos);
  }
}(this, function(ApiClient, Video, Player, VideoSubtitlesResponse, VideoIDList, VideoAccessInfo, Subscriptions, Bonus, Image, DownloadInformations, Features, Geolocs, VideoViews, Videos2, Videos) {
  'use strict';
