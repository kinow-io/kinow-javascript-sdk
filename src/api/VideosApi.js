...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Video', 'model/Subscriptions', 'model/Bonus', 'model/DownloadUrl', 'model/Features', 'model/Geolocs', 'model/PlayerConfiguration', 'model/VideoSubtitlesResponse', 'model/VideoViews', 'model/Videos'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Video'), require('../model/Subscriptions'), require('../model/Bonus'), require('../model/DownloadUrl'), require('../model/Features'), require('../model/Geolocs'), require('../model/PlayerConfiguration'), require('../model/VideoSubtitlesResponse'), require('../model/VideoViews'), require('../model/Videos'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.VideosApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Video, root.KinowJavascriptSdk.Subscriptions, root.KinowJavascriptSdk.Bonus, root.KinowJavascriptSdk.DownloadUrl, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.PlayerConfiguration, root.KinowJavascriptSdk.VideoSubtitlesResponse, root.KinowJavascriptSdk.VideoViews, root.KinowJavascriptSdk.Videos);
  }
}(this, function(ApiClient, Video, Subscriptions, Bonus, DownloadUrl, Features, Geolocs, PlayerConfiguration, VideoSubtitlesResponse, VideoViews, Videos) {
  'use strict';
