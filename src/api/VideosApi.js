...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Video', 'model/Player', 'model/VideoSubtitlesResponse', 'model/VideoIDList', 'model/VideoAccessInfo', 'model/Subscriptions', 'model/Bonus', 'model/Image', 'model/DownloadInformations', 'model/Features', 'model/Geolocs', 'model/Player1', 'model/VideoViews', 'model/Videos2', 'model/Videos'], factory);
...
}(this, function(ApiClient, Video, Player, VideoSubtitlesResponse, VideoIDList, VideoAccessInfo, Subscriptions, Bonus, Image, DownloadInformations, Features, Geolocs, Player1, VideoViews, Videos2, Videos) {
  'use strict';
