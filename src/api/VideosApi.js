...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Video', 'model/Subscriptions', 'model/DownloadUrl', 'model/MarlinToken', 'model/VideoUrl', 'model/Features', 'model/Geolocs', 'model/PlayerConfiguration', 'model/Subtitles', 'model/VideoViews', 'model/Videos'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Video'), require('../model/Subscriptions'), require('../model/DownloadUrl'), require('../model/MarlinToken'), require('../model/VideoUrl'), require('../model/Features'), require('../model/Geolocs'), require('../model/PlayerConfiguration'), require('../model/Subtitles'), require('../model/VideoViews'), require('../model/Videos'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.VideosApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Video, root.KinowJavascriptSdk.Subscriptions, root.KinowJavascriptSdk.DownloadUrl, root.KinowJavascriptSdk.MarlinToken, root.KinowJavascriptSdk.VideoUrl, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.PlayerConfiguration, root.KinowJavascriptSdk.Subtitles, root.KinowJavascriptSdk.VideoViews, root.KinowJavascriptSdk.Videos);
  }
}(this, function(ApiClient, Video, Subscriptions, DownloadUrl, MarlinToken, VideoUrl, Features, Geolocs, PlayerConfiguration, Subtitles, VideoViews, Videos) {
  'use strict';
