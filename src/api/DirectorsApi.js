...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Director', 'model/CreateDirectorRequest', 'model/CategoryDirectorsResponse', 'model/DirectorResponse', 'model/ImageResponse', 'model/DirectorProductListResponse', 'model/DirectorProductRoleListResponse', 'model/DirectorListResponse', 'model/DirectorRoleListResponse', 'model/UpdateDirectorRequest', 'model/UploadDirectorCoverRequest', 'model/Image'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Director'), require('../model/CreateDirectorRequest'), require('../model/CategoryDirectorsResponse'), require('../model/DirectorResponse'), require('../model/ImageResponse'), require('../model/DirectorProductListResponse'), require('../model/DirectorProductRoleListResponse'), require('../model/DirectorListResponse'), require('../model/DirectorRoleListResponse'), require('../model/UpdateDirectorRequest'), require('../model/UploadDirectorCoverRequest'), require('../model/Image'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.DirectorsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Director, root.KinowJavascriptSdk.CreateDirectorRequest, root.KinowJavascriptSdk.CategoryDirectorsResponse, root.KinowJavascriptSdk.DirectorResponse, root.KinowJavascriptSdk.ImageResponse, root.KinowJavascriptSdk.DirectorProductListResponse, root.KinowJavascriptSdk.DirectorProductRoleListResponse, root.KinowJavascriptSdk.DirectorListResponse, root.KinowJavascriptSdk.DirectorRoleListResponse, root.KinowJavascriptSdk.UpdateDirectorRequest, root.KinowJavascriptSdk.UploadDirectorCoverRequest, root.KinowJavascriptSdk.Image);
  }
}(this, function(ApiClient, Director, CreateDirectorRequest, CategoryDirectorsResponse, DirectorResponse, ImageResponse, DirectorProductListResponse, DirectorProductRoleListResponse, DirectorListResponse, DirectorRoleListResponse, UpdateDirectorRequest, UploadDirectorCoverRequest, Image) {
  'use strict';
