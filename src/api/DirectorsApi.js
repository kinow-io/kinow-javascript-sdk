...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Director', 'model/CreateDirectorRequest', 'model/CategoryDirectorsListResponse', 'model/DirectorResponse', 'model/ImageResponse', 'model/FeatureListResponse', 'model/DirectorProductListResponse', 'model/DirectorProductRoleListResponse', 'model/DirectorListResponse', 'model/DirectorRoleListResponse', 'model/UpdateDirectorRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Director'), require('../model/CreateDirectorRequest'), require('../model/CategoryDirectorsListResponse'), require('../model/DirectorResponse'), require('../model/ImageResponse'), require('../model/FeatureListResponse'), require('../model/DirectorProductListResponse'), require('../model/DirectorProductRoleListResponse'), require('../model/DirectorListResponse'), require('../model/DirectorRoleListResponse'), require('../model/UpdateDirectorRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.DirectorsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Director, root.KinowJavascriptSdk.CreateDirectorRequest, root.KinowJavascriptSdk.CategoryDirectorsListResponse, root.KinowJavascriptSdk.DirectorResponse, root.KinowJavascriptSdk.ImageResponse, root.KinowJavascriptSdk.FeatureListResponse, root.KinowJavascriptSdk.DirectorProductListResponse, root.KinowJavascriptSdk.DirectorProductRoleListResponse, root.KinowJavascriptSdk.DirectorListResponse, root.KinowJavascriptSdk.DirectorRoleListResponse, root.KinowJavascriptSdk.UpdateDirectorRequest);
  }
}(this, function(ApiClient, Director, CreateDirectorRequest, CategoryDirectorsListResponse, DirectorResponse, ImageResponse, FeatureListResponse, DirectorProductListResponse, DirectorProductRoleListResponse, DirectorListResponse, DirectorRoleListResponse, UpdateDirectorRequest) {
  'use strict';
