...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Director', 'model/CreateDirectorRequest', 'model/CategoryDirectorsResponse', 'model/DirectorResponse', 'model/ImageResponse', 'model/DirectorProductListResponse', 'model/DirectorProductRoleListResponse', 'model/DirectorListResponse', 'model/DirectorRoleListResponse', 'model/UpdateDirectorRequest'], factory);
...
}(this, function(ApiClient, Director, CreateDirectorRequest, CategoryDirectorsResponse, DirectorResponse, ImageResponse, DirectorProductListResponse, DirectorProductRoleListResponse, DirectorListResponse, DirectorRoleListResponse, UpdateDirectorRequest) {
  'use strict';
