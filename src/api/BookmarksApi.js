...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} opts.playlistId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.attachBookmarkToCustomerWithHttpInfo = function(customerId, productId, opts) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.attachBookmarkToCustomer = function(customerId, productId, opts) {
      return this.attachBookmarkToCustomerWithHttpInfo(customerId, productId, opts)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.detachBookmarkFromCustomerWithHttpInfo = function(customerId, productId, opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.detachBookmarkFromCustomer = function(customerId, productId, opts) {
      return this.detachBookmarkFromCustomerWithHttpInfo(customerId, productId, opts)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
