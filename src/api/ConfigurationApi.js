...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConfigurationList', 'model/Analytics', 'model/Configuration', 'model/LogoSettings', 'model/SocialSettings'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ConfigurationList'), require('../model/Analytics'), require('../model/Configuration'), require('../model/LogoSettings'), require('../model/SocialSettings'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ConfigurationApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.ConfigurationList, root.KinowJavascriptSdk.Analytics, root.KinowJavascriptSdk.Configuration, root.KinowJavascriptSdk.LogoSettings, root.KinowJavascriptSdk.SocialSettings);
  }
}(this, function(ApiClient, ConfigurationList, Analytics, Configuration, LogoSettings, SocialSettings) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Analytics} and HTTP response
     */
    this.getConfigurationAnalyticsWithHttpInfo = function() {
      var postBody = null;
    ...
    /**
     * Get analytics configuration
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Analytics}
     */
    this.getConfigurationAnalytics = function() {
      return this.getConfigurationAnalyticsWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
