...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProductAccess', 'model/SubscriptionAccesses'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ProductAccess'), require('../model/SubscriptionAccesses'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ProductAccessesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.ProductAccess, root.KinowJavascriptSdk.SubscriptionAccesses);
  }
}(this, function(ApiClient, ProductAccess, SubscriptionAccesses) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} productAccessId ID of the product access to fetch
     ...
     * @param {Integer} customerId ID of the user to unsubscribe
     * @param {String} productAccessId ID of the product access to unsubscribe from
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
     ...
     * @param {Integer} productAccessId ID of the product access to update
     * @param {module:model/ProductAccess} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ProductAccess} and HTTP response
     */
