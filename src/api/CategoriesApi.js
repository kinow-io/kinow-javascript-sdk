...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getCategoryPlayerWithHttpInfo = function(videoId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling getCategoryPlayer");
      }
     ...
     */
    this.getCategoryPlayer = function(videoId, opts) {
      return this.getCategoryPlayerWithHttpInfo(videoId, opts)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
