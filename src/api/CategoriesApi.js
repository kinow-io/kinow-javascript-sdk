...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateCategoryRequest', 'model/CategoryResponse', 'model/CategoryListResponse', 'model/CategoryActorsResponse', 'model/ImageResponse', 'model/CategoryDirectorsResponse', 'model/FeatureListResponse', 'model/CategoryImagesResponse', 'model/ProductListResponse', 'model/Player', 'model/SubtitleListResponse', 'model/VideoCategoryListResponse', 'model/UpdateCategoryRequest', 'model/UploadCategoryCoverRequest', 'model/Image'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateCategoryRequest'), require('../model/CategoryResponse'), require('../model/CategoryListResponse'), require('../model/CategoryActorsResponse'), require('../model/ImageResponse'), require('../model/CategoryDirectorsResponse'), require('../model/FeatureListResponse'), require('../model/CategoryImagesResponse'), require('../model/ProductListResponse'), require('../model/Player'), require('../model/SubtitleListResponse'), require('../model/VideoCategoryListResponse'), require('../model/UpdateCategoryRequest'), require('../model/UploadCategoryCoverRequest'), require('../model/Image'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CategoriesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CreateCategoryRequest, root.KinowJavascriptSdk.CategoryResponse, root.KinowJavascriptSdk.CategoryListResponse, root.KinowJavascriptSdk.CategoryActorsResponse, root.KinowJavascriptSdk.ImageResponse, root.KinowJavascriptSdk.CategoryDirectorsResponse, root.KinowJavascriptSdk.FeatureListResponse, root.KinowJavascriptSdk.CategoryImagesResponse, root.KinowJavascriptSdk.ProductListResponse, root.KinowJavascriptSdk.Player, root.KinowJavascriptSdk.SubtitleListResponse, root.KinowJavascriptSdk.VideoCategoryListResponse, root.KinowJavascriptSdk.UpdateCategoryRequest, root.KinowJavascriptSdk.UploadCategoryCoverRequest, root.KinowJavascriptSdk.Image);
  }
}(this, function(ApiClient, CreateCategoryRequest, CategoryResponse, CategoryListResponse, CategoryActorsResponse, ImageResponse, CategoryDirectorsResponse, FeatureListResponse, CategoryImagesResponse, ProductListResponse, Player, SubtitleListResponse, VideoCategoryListResponse, UpdateCategoryRequest, UploadCategoryCoverRequest, Image) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CategoryActorsResponse} and HTTP response
     */
    this.getCategoryActorsWithHttpInfo = function(categoryId, opts) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = CategoryActorsResponse;
     ...
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CategoryActorsResponse}
     */
     ...
     * @param {module:model/UploadCategoryCoverRequest} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ImageResponse} and HTTP response
     */
    this.uploadCategoryCoverWithHttpInfo = function(body) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling uploadCategoryCover");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ImageResponse}
     */
    this.uploadCategoryCover = function(body) {
      return this.uploadCategoryCoverWithHttpInfo(body)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
