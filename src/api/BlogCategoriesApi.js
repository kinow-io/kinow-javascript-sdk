...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BlogCategoryListResponse', 'model/BlogCategoryResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BlogCategoryListResponse'), require('../model/BlogCategoryResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.BlogCategoriesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.BlogCategoryListResponse, root.KinowJavascriptSdk.BlogCategoryResponse);
  }
}(this, function(ApiClient, BlogCategoryListResponse, BlogCategoryResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BlogCategoryListResponse} and HTTP response
     */
    this.getBlogCategoriesWithHttpInfo = function(opts) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = BlogCategoryListResponse;
     ...
     * @param {String} opts.sortBy Sort by this attribute (id by default)
     * @param {module:model/String} opts.sortDirection Sorting direction (asc by default)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/BlogCategoryListResponse}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/BlogCategoryResponse} and HTTP response
     */
    this.getBlogCategoryWithHttpInfo = function(blogCategoryId) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = BlogCategoryResponse;
     ...
     * Get blog category
     * @param {Integer} blogCategoryId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/BlogCategoryResponse}
     */
