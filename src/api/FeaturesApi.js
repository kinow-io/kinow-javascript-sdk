...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FeatureListResponse', 'model/Features', 'model/FeatureValueListResponse1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/FeatureListResponse'), require('../model/Features'), require('../model/FeatureValueListResponse1'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.FeaturesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.FeatureListResponse, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.FeatureValueListResponse1);
  }
}(this, function(ApiClient, FeatureListResponse, Features, FeatureValueListResponse1) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} features      To attach existing FeatureValue to actor:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;id_feature_value\&quot;:5     }]     &#x60;&#x60;&#x60;      To create a custom FeatureValue:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;custom_value\&quot;:[{     \&quot;lang\&quot;: 1,     \&quot;value\&quot;: \&quot;string\&quot;     }]     }]     &#x60;&#x60;&#x60;
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.attachFeaturesToActorWithHttpInfo = function(actorId, features) {
      var postBody = null;

      // verify the required parameter 'actorId' is set
      if (actorId === undefined || actorId === null) {
        throw new Error("Missing the required parameter 'actorId' when calling attachFeaturesToActor");
      }

      // verify the required parameter 'features' is set
      if (features === undefined || features === null) {
        throw new Error("Missing the required parameter 'features' when calling attachFeaturesToActor");
      }
     ...
     */
    this.attachFeaturesToActor = function(actorId, features) {
      return this.attachFeaturesToActorWithHttpInfo(actorId, features)
     ...
     * @param {String} features      To attach existing FeatureValue to blog page:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;id_feature_value\&quot;:5     }]     &#x60;&#x60;&#x60;      To create a custom FeatureValue:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;custom_value\&quot;:[{     \&quot;lang\&quot;: 1,     \&quot;value\&quot;: \&quot;string\&quot;     }]     }]     &#x60;&#x60;&#x60;
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.attachFeaturesToBlogPageWithHttpInfo = function(blogPageId, features) {
      var postBody = null;

      // verify the required parameter 'blogPageId' is set
      if (blogPageId === undefined || blogPageId === null) {
        throw new Error("Missing the required parameter 'blogPageId' when calling attachFeaturesToBlogPage");
      }

      // verify the required parameter 'features' is set
      if (features === undefined || features === null) {
        throw new Error("Missing the required parameter 'features' when calling attachFeaturesToBlogPage");
      }
      ...
      return this.apiClient.callApi(
        '/blog-pages/{blog_page_id}/features', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.attachFeaturesToBlogPage = function(blogPageId, features) {
      return this.attachFeaturesToBlogPageWithHttpInfo(blogPageId, features)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     * @param {String} features      To attach existing FeatureValue to director:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;id_feature_value\&quot;:5     }]     &#x60;&#x60;&#x60;      To create a custom FeatureValue:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;custom_value\&quot;:[{     \&quot;lang\&quot;: 1,     \&quot;value\&quot;: \&quot;string\&quot;     }]     }]     &#x60;&#x60;&#x60;
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.attachFeaturesToDirectorWithHttpInfo = function(directorId, features) {
      var postBody = null;

      // verify the required parameter 'directorId' is set
      if (directorId === undefined || directorId === null) {
        throw new Error("Missing the required parameter 'directorId' when calling attachFeaturesToDirector");
      }

      // verify the required parameter 'features' is set
      if (features === undefined || features === null) {
        throw new Error("Missing the required parameter 'features' when calling attachFeaturesToDirector");
      }
      ...
      return this.apiClient.callApi(
        '/directors/{director_id}/features', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.attachFeaturesToDirector = function(directorId, features) {
      return this.attachFeaturesToDirectorWithHttpInfo(directorId, features)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     */
    this.getActorFeaturesWithHttpInfo = function(actorId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'actorId' is set
      if (actorId === undefined || actorId === null) {
        throw new Error("Missing the required parameter 'actorId' when calling getActorFeatures");
      }
     ...
     */
    this.getActorFeatures = function(actorId, opts) {
      return this.getActorFeaturesWithHttpInfo(actorId, opts)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     * @param {Integer} blogPageId Blog page ID to fetch
     * @param {Object} opts Optional parameters
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FeatureListResponse} and HTTP response
     */
    this.getBlogPageFeaturesWithHttpInfo = function(blogPageId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'blogPageId' is set
      if (blogPageId === undefined || blogPageId === null) {
        throw new Error("Missing the required parameter 'blogPageId' when calling getBlogPageFeatures");
      }
      ...
      return this.apiClient.callApi(
        '/blog-pages/{blog_page_id}/features', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/FeatureListResponse}
     */
    this.getBlogPageFeatures = function(blogPageId, opts) {
      return this.getBlogPageFeaturesWithHttpInfo(blogPageId, opts)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FeatureListResponse} and HTTP response
     */
    this.getDirectorFeaturesWithHttpInfo = function(directorId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'directorId' is set
      if (directorId === undefined || directorId === null) {
        throw new Error("Missing the required parameter 'directorId' when calling getDirectorFeatures");
      }
      ...
      return this.apiClient.callApi(
        '/directors/{director_id}/features', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/FeatureListResponse}
     */
    this.getDirectorFeatures = function(directorId, opts) {
      return this.getDirectorFeaturesWithHttpInfo(directorId, opts)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FeatureValueListResponse1} and HTTP response
     */
    this.getFeatureValuesWithHttpInfo = function(opts) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = FeatureValueListResponse1;
     ...
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/FeatureValueListResponse1}
     */
