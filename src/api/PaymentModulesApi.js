...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentModules', 'model/PaymentMethods', 'model/PaymentToken1', 'model/PaymentUrl', 'model/PaymentDetails', 'model/PaymentDetails1', 'model/PaymentArguments'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PaymentModules'), require('../model/PaymentMethods'), require('../model/PaymentToken1'), require('../model/PaymentUrl'), require('../model/PaymentDetails'), require('../model/PaymentDetails1'), require('../model/PaymentArguments'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.PaymentModulesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.PaymentModules, root.KinowJavascriptSdk.PaymentMethods, root.KinowJavascriptSdk.PaymentToken1, root.KinowJavascriptSdk.PaymentUrl, root.KinowJavascriptSdk.PaymentDetails, root.KinowJavascriptSdk.PaymentDetails1, root.KinowJavascriptSdk.PaymentArguments);
  }
}(this, function(ApiClient, PaymentModules, PaymentMethods, PaymentToken1, PaymentUrl, PaymentDetails, PaymentDetails1, PaymentArguments) {
  'use strict';
