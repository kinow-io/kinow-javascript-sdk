...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentModules', 'model/PaymentMethodsResponse', 'model/PaymentModuleListResponse', 'model/PaymentToken1', 'model/PaymentUrlResponse', 'model/PaymentDetailsResponse', 'model/PaymentDetailsListResponse', 'model/PaymentDetailsResponse1', 'model/PaymentArguments', 'model/UpdatePaymentRequest', 'model/PaymentArgumentsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PaymentModules'), require('../model/PaymentMethodsResponse'), require('../model/PaymentModuleListResponse'), require('../model/PaymentToken1'), require('../model/PaymentUrlResponse'), require('../model/PaymentDetailsResponse'), require('../model/PaymentDetailsListResponse'), require('../model/PaymentDetailsResponse1'), require('../model/PaymentArguments'), require('../model/UpdatePaymentRequest'), require('../model/PaymentArgumentsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.PaymentModulesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.PaymentModules, root.KinowJavascriptSdk.PaymentMethodsResponse, root.KinowJavascriptSdk.PaymentModuleListResponse, root.KinowJavascriptSdk.PaymentToken1, root.KinowJavascriptSdk.PaymentUrlResponse, root.KinowJavascriptSdk.PaymentDetailsResponse, root.KinowJavascriptSdk.PaymentDetailsListResponse, root.KinowJavascriptSdk.PaymentDetailsResponse1, root.KinowJavascriptSdk.PaymentArguments, root.KinowJavascriptSdk.UpdatePaymentRequest, root.KinowJavascriptSdk.PaymentArgumentsResponse);
  }
}(this, function(ApiClient, PaymentModules, PaymentMethodsResponse, PaymentModuleListResponse, PaymentToken1, PaymentUrlResponse, PaymentDetailsResponse, PaymentDetailsListResponse, PaymentDetailsResponse1, PaymentArguments, UpdatePaymentRequest, PaymentArgumentsResponse) {
  'use strict';
