...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentModuleListResponse1', 'model/PaymentMethods', 'model/PaymentModuleListResponse', 'model/PaymentToken1', 'model/PaymentUrlResponse', 'model/PaymentDetails', 'model/PaymentDetailsListResponse', 'model/PaymentDetailsResponse', 'model/PaymentArguments', 'model/UpdatePaymentRequest', 'model/PaymentArgumentsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PaymentModuleListResponse1'), require('../model/PaymentMethods'), require('../model/PaymentModuleListResponse'), require('../model/PaymentToken1'), require('../model/PaymentUrlResponse'), require('../model/PaymentDetails'), require('../model/PaymentDetailsListResponse'), require('../model/PaymentDetailsResponse'), require('../model/PaymentArguments'), require('../model/UpdatePaymentRequest'), require('../model/PaymentArgumentsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.PaymentModulesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.PaymentModuleListResponse1, root.KinowJavascriptSdk.PaymentMethods, root.KinowJavascriptSdk.PaymentModuleListResponse, root.KinowJavascriptSdk.PaymentToken1, root.KinowJavascriptSdk.PaymentUrlResponse, root.KinowJavascriptSdk.PaymentDetails, root.KinowJavascriptSdk.PaymentDetailsListResponse, root.KinowJavascriptSdk.PaymentDetailsResponse, root.KinowJavascriptSdk.PaymentArguments, root.KinowJavascriptSdk.UpdatePaymentRequest, root.KinowJavascriptSdk.PaymentArgumentsResponse);
  }
}(this, function(ApiClient, PaymentModuleListResponse1, PaymentMethods, PaymentModuleListResponse, PaymentToken1, PaymentUrlResponse, PaymentDetails, PaymentDetailsListResponse, PaymentDetailsResponse, PaymentArguments, UpdatePaymentRequest, PaymentArgumentsResponse) {
  'use strict';
