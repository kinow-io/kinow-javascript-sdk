...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomerGroupVideoStatsListResponse', 'model/SessionVideoStatListResponse', 'model/VideoIDList2', 'model/SessionVideoStat', 'model/CustomerVideoStatsListResponse', 'model/VideoIDList1', 'model/VideoViewInformations', 'model/VideoStatListResponse', 'model/View'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CustomerGroupVideoStatsListResponse'), require('../model/SessionVideoStatListResponse'), require('../model/VideoIDList2'), require('../model/SessionVideoStat'), require('../model/CustomerVideoStatsListResponse'), require('../model/VideoIDList1'), require('../model/VideoViewInformations'), require('../model/VideoStatListResponse'), require('../model/View'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.StatsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CustomerGroupVideoStatsListResponse, root.KinowJavascriptSdk.SessionVideoStatListResponse, root.KinowJavascriptSdk.VideoIDList2, root.KinowJavascriptSdk.SessionVideoStat, root.KinowJavascriptSdk.CustomerVideoStatsListResponse, root.KinowJavascriptSdk.VideoIDList1, root.KinowJavascriptSdk.VideoViewInformations, root.KinowJavascriptSdk.VideoStatListResponse, root.KinowJavascriptSdk.View);
  }
}(this, function(ApiClient, CustomerGroupVideoStatsListResponse, SessionVideoStatListResponse, VideoIDList2, SessionVideoStat, CustomerVideoStatsListResponse, VideoIDList1, VideoViewInformations, VideoStatListResponse, View) {
  'use strict';
