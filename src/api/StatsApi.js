...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomerGroupVideoStatsListResponse', 'model/SessionVideoStatListResponse', 'model/VideoIDList1', 'model/SessionVideoStat', 'model/CustomerVideoStatsListResponse', 'model/VideoStatListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CustomerGroupVideoStatsListResponse'), require('../model/SessionVideoStatListResponse'), require('../model/VideoIDList1'), require('../model/SessionVideoStat'), require('../model/CustomerVideoStatsListResponse'), require('../model/VideoStatListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.StatsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CustomerGroupVideoStatsListResponse, root.KinowJavascriptSdk.SessionVideoStatListResponse, root.KinowJavascriptSdk.VideoIDList1, root.KinowJavascriptSdk.SessionVideoStat, root.KinowJavascriptSdk.CustomerVideoStatsListResponse, root.KinowJavascriptSdk.VideoStatListResponse);
  }
}(this, function(ApiClient, CustomerGroupVideoStatsListResponse, SessionVideoStatListResponse, VideoIDList1, SessionVideoStat, CustomerVideoStatsListResponse, VideoStatListResponse) {
  'use strict';
