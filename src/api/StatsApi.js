...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomerGroupVideoStats1', 'model/SessionVideoStats', 'model/VideoIDList1', 'model/CustomerVideoStats1', 'model/VideoStats'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CustomerGroupVideoStats1'), require('../model/SessionVideoStats'), require('../model/VideoIDList1'), require('../model/CustomerVideoStats1'), require('../model/VideoStats'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.StatsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CustomerGroupVideoStats1, root.KinowJavascriptSdk.SessionVideoStats, root.KinowJavascriptSdk.VideoIDList1, root.KinowJavascriptSdk.CustomerVideoStats1, root.KinowJavascriptSdk.VideoStats);
  }
}(this, function(ApiClient, CustomerGroupVideoStats1, SessionVideoStats, VideoIDList1, CustomerVideoStats1, VideoStats) {
  'use strict';
