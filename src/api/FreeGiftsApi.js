...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FreeGift1', 'model/FreeGift', 'model/GiftToken', 'model/Gifts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/FreeGift1'), require('../model/FreeGift'), require('../model/GiftToken'), require('../model/Gifts'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.FreeGiftsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.FreeGift1, root.KinowJavascriptSdk.FreeGift, root.KinowJavascriptSdk.GiftToken, root.KinowJavascriptSdk.Gifts);
  }
}(this, function(ApiClient, FreeGift1, FreeGift, GiftToken, Gifts) {
  'use strict';
