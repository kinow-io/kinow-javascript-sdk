...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GeolocSettingsResponse', 'model/IPLocationResponse', 'model/PlatformAccessResponse', 'model/GeolocationListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GeolocSettingsResponse'), require('../model/IPLocationResponse'), require('../model/PlatformAccessResponse'), require('../model/GeolocationListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.GeolocationsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.GeolocSettingsResponse, root.KinowJavascriptSdk.IPLocationResponse, root.KinowJavascriptSdk.PlatformAccessResponse, root.KinowJavascriptSdk.GeolocationListResponse);
  }
}(this, function(ApiClient, GeolocSettingsResponse, IPLocationResponse, PlatformAccessResponse, GeolocationListResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GeolocSettingsResponse} and HTTP response
     */
    this.getGeolocSettingsWithHttpInfo = function(type, typeId) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = GeolocSettingsResponse;
     ...
     * @param {String} type Item type, available values are: category, subscription, product, video, extract, blogpage, slider, topmenu, homerail
     * @param {Integer} typeId Item ID
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GeolocSettingsResponse}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/IPLocationResponse} and HTTP response
     */
    this.getIPLocationWithHttpInfo = function(ipAddress) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = IPLocationResponse;
     ...
     * Get IP location
     * @param {String} ipAddress address ip
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/IPLocationResponse}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PlatformAccessResponse} and HTTP response
     */
    this.getPlatformAccessInfoWithHttpInfo = function(ipAddress) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = PlatformAccessResponse;
     ...
     * Get PlatformAccessInfo by ip
     * @param {String} ipAddress IP address
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PlatformAccessResponse}
     */
