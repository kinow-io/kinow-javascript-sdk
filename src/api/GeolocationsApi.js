...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PlatformAccessInfo', 'model/IPLocation', 'model/Geolocs'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PlatformAccessInfo'), require('../model/IPLocation'), require('../model/Geolocs'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.GeolocationsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.PlatformAccessInfo, root.KinowJavascriptSdk.IPLocation, root.KinowJavascriptSdk.Geolocs);
  }
}(this, function(ApiClient, PlatformAccessInfo, IPLocation, Geolocs) {
  'use strict';
