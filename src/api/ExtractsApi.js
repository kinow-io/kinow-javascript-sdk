...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Extract', 'model/Subtitle', 'model/CreateExtractSubtitleRequest', 'model/Features', 'model/PlayerConfiguration', 'model/VideoSubtitlesResponse', 'model/Videos1', 'model/ExtractAccessInfo', 'model/ExtractIDList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Extract'), require('../model/Subtitle'), require('../model/CreateExtractSubtitleRequest'), require('../model/Features'), require('../model/PlayerConfiguration'), require('../model/VideoSubtitlesResponse'), require('../model/Videos1'), require('../model/ExtractAccessInfo'), require('../model/ExtractIDList'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ExtractsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Extract, root.KinowJavascriptSdk.Subtitle, root.KinowJavascriptSdk.CreateExtractSubtitleRequest, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.PlayerConfiguration, root.KinowJavascriptSdk.VideoSubtitlesResponse, root.KinowJavascriptSdk.Videos1, root.KinowJavascriptSdk.ExtractAccessInfo, root.KinowJavascriptSdk.ExtractIDList);
  }
}(this, function(ApiClient, Extract, Subtitle, CreateExtractSubtitleRequest, Features, PlayerConfiguration, VideoSubtitlesResponse, Videos1, ExtractAccessInfo, ExtractIDList) {
  'use strict';
