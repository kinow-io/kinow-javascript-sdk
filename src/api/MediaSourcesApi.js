...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConvertMediaLiveRequest', 'model/CreateMediaLiveRequest', 'model/MediaSourceResponse', 'model/MediaFileListResponse', 'model/MediaSourceListResponse', 'model/CreateMediaFileRequest', 'model/MediaFileResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ConvertMediaLiveRequest'), require('../model/CreateMediaLiveRequest'), require('../model/MediaSourceResponse'), require('../model/MediaFileListResponse'), require('../model/MediaSourceListResponse'), require('../model/CreateMediaFileRequest'), require('../model/MediaFileResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.MediaSourcesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.ConvertMediaLiveRequest, root.KinowJavascriptSdk.CreateMediaLiveRequest, root.KinowJavascriptSdk.MediaSourceResponse, root.KinowJavascriptSdk.MediaFileListResponse, root.KinowJavascriptSdk.MediaSourceListResponse, root.KinowJavascriptSdk.CreateMediaFileRequest, root.KinowJavascriptSdk.MediaFileResponse);
  }
}(this, function(ApiClient, ConvertMediaLiveRequest, CreateMediaLiveRequest, MediaSourceResponse, MediaFileListResponse, MediaSourceListResponse, CreateMediaFileRequest, MediaFileResponse) {
  'use strict';
