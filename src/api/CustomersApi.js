...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Cart', 'model/Customer', 'model/CustomerCreateRequest', 'model/SubscriptionAccesses', 'model/Address', 'model/Carts', 'model/CustomerCurrentViews', 'model/Groups', 'model/ProductAccessInfo', 'model/ProductIDList', 'model/VideoIDList', 'model/VideoAccessInfo', 'model/Orders', 'model/PrepaymentBalance', 'model/PrepaymentOperations', 'model/VideoIDList1', 'model/SessionVideoStats', 'model/Customers', 'model/CustomerId', 'model/PaymentMethods', 'model/PaymentDetails', 'model/Token', 'model/PaymentArguments'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Cart'), require('../model/Customer'), require('../model/CustomerCreateRequest'), require('../model/SubscriptionAccesses'), require('../model/Address'), require('../model/Carts'), require('../model/CustomerCurrentViews'), require('../model/Groups'), require('../model/ProductAccessInfo'), require('../model/ProductIDList'), require('../model/VideoIDList'), require('../model/VideoAccessInfo'), require('../model/Orders'), require('../model/PrepaymentBalance'), require('../model/PrepaymentOperations'), require('../model/VideoIDList1'), require('../model/SessionVideoStats'), require('../model/Customers'), require('../model/CustomerId'), require('../model/PaymentMethods'), require('../model/PaymentDetails'), require('../model/Token'), require('../model/PaymentArguments'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CustomersApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Cart, root.KinowJavascriptSdk.Customer, root.KinowJavascriptSdk.CustomerCreateRequest, root.KinowJavascriptSdk.SubscriptionAccesses, root.KinowJavascriptSdk.Address, root.KinowJavascriptSdk.Carts, root.KinowJavascriptSdk.CustomerCurrentViews, root.KinowJavascriptSdk.Groups, root.KinowJavascriptSdk.ProductAccessInfo, root.KinowJavascriptSdk.ProductIDList, root.KinowJavascriptSdk.VideoIDList, root.KinowJavascriptSdk.VideoAccessInfo, root.KinowJavascriptSdk.Orders, root.KinowJavascriptSdk.PrepaymentBalance, root.KinowJavascriptSdk.PrepaymentOperations, root.KinowJavascriptSdk.VideoIDList1, root.KinowJavascriptSdk.SessionVideoStats, root.KinowJavascriptSdk.Customers, root.KinowJavascriptSdk.CustomerId, root.KinowJavascriptSdk.PaymentMethods, root.KinowJavascriptSdk.PaymentDetails, root.KinowJavascriptSdk.Token, root.KinowJavascriptSdk.PaymentArguments);
  }
}(this, function(ApiClient, Cart, Customer, CustomerCreateRequest, SubscriptionAccesses, Address, Carts, CustomerCurrentViews, Groups, ProductAccessInfo, ProductIDList, VideoIDList, VideoAccessInfo, Orders, PrepaymentBalance, PrepaymentOperations, VideoIDList1, SessionVideoStats, Customers, CustomerId, PaymentMethods, PaymentDetails, Token, PaymentArguments) {
  'use strict';
