...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CartResponse', 'model/CustomerResponse', 'model/CreateCustomerRequest', 'model/ProductAccessListResponse', 'model/AddressResponse', 'model/ProductListResponse', 'model/CartListResponse', 'model/CustomerCommentListResponse1', 'model/CustomerCurrentViewsResponse', 'model/GroupListResponse', 'model/ProductIDList', 'model/ProductAccessInfoResponse', 'model/VideoIDList', 'model/VideoAccessInfo', 'model/OrderListResponse', 'model/PlaylistListResponse', 'model/PrepaymentBalance', 'model/PrepaymentOperationListResponse', 'model/CustomerListResponse', 'model/CustomerId', 'model/PaymentMethods', 'model/PaymentDetails', 'model/RegistrationFieldsResponse', 'model/Customer', 'model/TokenResponse', 'model/UpdateCustomerRequest', 'model/UpdatePaymentRequest', 'model/CredentialsValidationResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CartResponse'), require('../model/CustomerResponse'), require('../model/CreateCustomerRequest'), require('../model/ProductAccessListResponse'), require('../model/AddressResponse'), require('../model/ProductListResponse'), require('../model/CartListResponse'), require('../model/CustomerCommentListResponse1'), require('../model/CustomerCurrentViewsResponse'), require('../model/GroupListResponse'), require('../model/ProductIDList'), require('../model/ProductAccessInfoResponse'), require('../model/VideoIDList'), require('../model/VideoAccessInfo'), require('../model/OrderListResponse'), require('../model/PlaylistListResponse'), require('../model/PrepaymentBalance'), require('../model/PrepaymentOperationListResponse'), require('../model/CustomerListResponse'), require('../model/CustomerId'), require('../model/PaymentMethods'), require('../model/PaymentDetails'), require('../model/RegistrationFieldsResponse'), require('../model/Customer'), require('../model/TokenResponse'), require('../model/UpdateCustomerRequest'), require('../model/UpdatePaymentRequest'), require('../model/CredentialsValidationResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CustomersApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CartResponse, root.KinowJavascriptSdk.CustomerResponse, root.KinowJavascriptSdk.CreateCustomerRequest, root.KinowJavascriptSdk.ProductAccessListResponse, root.KinowJavascriptSdk.AddressResponse, root.KinowJavascriptSdk.ProductListResponse, root.KinowJavascriptSdk.CartListResponse, root.KinowJavascriptSdk.CustomerCommentListResponse1, root.KinowJavascriptSdk.CustomerCurrentViewsResponse, root.KinowJavascriptSdk.GroupListResponse, root.KinowJavascriptSdk.ProductIDList, root.KinowJavascriptSdk.ProductAccessInfoResponse, root.KinowJavascriptSdk.VideoIDList, root.KinowJavascriptSdk.VideoAccessInfo, root.KinowJavascriptSdk.OrderListResponse, root.KinowJavascriptSdk.PlaylistListResponse, root.KinowJavascriptSdk.PrepaymentBalance, root.KinowJavascriptSdk.PrepaymentOperationListResponse, root.KinowJavascriptSdk.CustomerListResponse, root.KinowJavascriptSdk.CustomerId, root.KinowJavascriptSdk.PaymentMethods, root.KinowJavascriptSdk.PaymentDetails, root.KinowJavascriptSdk.RegistrationFieldsResponse, root.KinowJavascriptSdk.Customer, root.KinowJavascriptSdk.TokenResponse, root.KinowJavascriptSdk.UpdateCustomerRequest, root.KinowJavascriptSdk.UpdatePaymentRequest, root.KinowJavascriptSdk.CredentialsValidationResponse);
  }
}(this, function(ApiClient, CartResponse, CustomerResponse, CreateCustomerRequest, ProductAccessListResponse, AddressResponse, ProductListResponse, CartListResponse, CustomerCommentListResponse1, CustomerCurrentViewsResponse, GroupListResponse, ProductIDList, ProductAccessInfoResponse, VideoIDList, VideoAccessInfo, OrderListResponse, PlaylistListResponse, PrepaymentBalance, PrepaymentOperationListResponse, CustomerListResponse, CustomerId, PaymentMethods, PaymentDetails, RegistrationFieldsResponse, Customer, TokenResponse, UpdateCustomerRequest, UpdatePaymentRequest, CredentialsValidationResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Boolean} opts.forceClientApiRefresh Return Client API refresh token
     * @param {Boolean} opts.forceClientApiAccess Return Client API access token
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link 'String'} and HTTP response
     */
    this.generateAuthenticationTokenWithHttpInfo = function(customerId, opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var queryParams = {
        'force_client_api_refresh': opts['forceClientApiRefresh'],
        'force_client_api_access': opts['forceClientApiAccess'],
      };
      var collectionQueryParams = {
      };
      var headerParams = {
     ...
     */
    this.generateAuthenticationToken = function(customerId, opts) {
      return this.generateAuthenticationTokenWithHttpInfo(customerId, opts)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
