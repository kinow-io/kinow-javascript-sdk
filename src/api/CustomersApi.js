...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CartResponse', 'model/CustomerResponse', 'model/CreateCustomerRequest', 'model/ProductAccessListResponse', 'model/AddressResponse', 'model/ProductListResponse', 'model/CartListResponse', 'model/CustomerCurrentViewsResponse', 'model/GroupListResponse', 'model/ProductIDList', 'model/ProductAccessInfoResponse', 'model/VideoAccessInfoResponse', 'model/VideoIDList', 'model/OrderListResponse', 'model/PlaylistListResponse', 'model/PrepaymentBalanceListResponse', 'model/PrepaymentOperationListResponse', 'model/CustomerListResponse', 'model/CustomerId', 'model/PaymentMethodsResponse', 'model/PaymentDetailsResponse', 'model/PaymentDetailsListResponse', 'model/RegistrationFieldsResponse', 'model/Customer', 'model/TokenResponse', 'model/UpdateCustomerRequest', 'model/UpdatePaymentRequest', 'model/CredentialsValidationResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CartResponse'), require('../model/CustomerResponse'), require('../model/CreateCustomerRequest'), require('../model/ProductAccessListResponse'), require('../model/AddressResponse'), require('../model/ProductListResponse'), require('../model/CartListResponse'), require('../model/CustomerCurrentViewsResponse'), require('../model/GroupListResponse'), require('../model/ProductIDList'), require('../model/ProductAccessInfoResponse'), require('../model/VideoAccessInfoResponse'), require('../model/VideoIDList'), require('../model/OrderListResponse'), require('../model/PlaylistListResponse'), require('../model/PrepaymentBalanceListResponse'), require('../model/PrepaymentOperationListResponse'), require('../model/CustomerListResponse'), require('../model/CustomerId'), require('../model/PaymentMethodsResponse'), require('../model/PaymentDetailsResponse'), require('../model/PaymentDetailsListResponse'), require('../model/RegistrationFieldsResponse'), require('../model/Customer'), require('../model/TokenResponse'), require('../model/UpdateCustomerRequest'), require('../model/UpdatePaymentRequest'), require('../model/CredentialsValidationResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CustomersApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CartResponse, root.KinowJavascriptSdk.CustomerResponse, root.KinowJavascriptSdk.CreateCustomerRequest, root.KinowJavascriptSdk.ProductAccessListResponse, root.KinowJavascriptSdk.AddressResponse, root.KinowJavascriptSdk.ProductListResponse, root.KinowJavascriptSdk.CartListResponse, root.KinowJavascriptSdk.CustomerCurrentViewsResponse, root.KinowJavascriptSdk.GroupListResponse, root.KinowJavascriptSdk.ProductIDList, root.KinowJavascriptSdk.ProductAccessInfoResponse, root.KinowJavascriptSdk.VideoAccessInfoResponse, root.KinowJavascriptSdk.VideoIDList, root.KinowJavascriptSdk.OrderListResponse, root.KinowJavascriptSdk.PlaylistListResponse, root.KinowJavascriptSdk.PrepaymentBalanceListResponse, root.KinowJavascriptSdk.PrepaymentOperationListResponse, root.KinowJavascriptSdk.CustomerListResponse, root.KinowJavascriptSdk.CustomerId, root.KinowJavascriptSdk.PaymentMethodsResponse, root.KinowJavascriptSdk.PaymentDetailsResponse, root.KinowJavascriptSdk.PaymentDetailsListResponse, root.KinowJavascriptSdk.RegistrationFieldsResponse, root.KinowJavascriptSdk.Customer, root.KinowJavascriptSdk.TokenResponse, root.KinowJavascriptSdk.UpdateCustomerRequest, root.KinowJavascriptSdk.UpdatePaymentRequest, root.KinowJavascriptSdk.CredentialsValidationResponse);
  }
}(this, function(ApiClient, CartResponse, CustomerResponse, CreateCustomerRequest, ProductAccessListResponse, AddressResponse, ProductListResponse, CartListResponse, CustomerCurrentViewsResponse, GroupListResponse, ProductIDList, ProductAccessInfoResponse, VideoAccessInfoResponse, VideoIDList, OrderListResponse, PlaylistListResponse, PrepaymentBalanceListResponse, PrepaymentOperationListResponse, CustomerListResponse, CustomerId, PaymentMethodsResponse, PaymentDetailsResponse, PaymentDetailsListResponse, RegistrationFieldsResponse, Customer, TokenResponse, UpdateCustomerRequest, UpdatePaymentRequest, CredentialsValidationResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Create new Customer
     * @param {module:model/CreateCustomerRequest} body Customer settings
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CustomerResponse} and HTTP response
     */
     ...
     * @param {Integer} customerId Customer ID to fetch
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CustomerCurrentViewsResponse} and HTTP response
     */
    this.getCustomerCurrentViewsWithHttpInfo = function(customerId) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = CustomerCurrentViewsResponse;
     ...
     * Get customer current number of views
     * @param {Integer} customerId Customer ID to fetch
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CustomerCurrentViewsResponse}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/PaymentMethodsResponse>} and HTTP response
     */
     ...
     * @param {Integer} customerId 
     * @param {String} paymentName 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/PaymentMethodsResponse>}
     */
     ...
     * @param {String} paymentName 
     * @param {Integer} customerId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/PaymentDetailsResponse>} and HTTP response
     */
     ...
     * @param {String} paymentName 
     * @param {Integer} customerId 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/PaymentDetailsResponse>}
     */
     ...
     * @param {Integer} customerId 
     * @param {String} ipAddress Filter by user IP
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PaymentDetailsListResponse} and HTTP response
     */
    this.getPendingPaymentsWithIpWithHttpInfo = function(paymentName, customerId, ipAddress) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = PaymentDetailsListResponse;
     ...
     * @param {Integer} customerId 
     * @param {String} ipAddress Filter by user IP
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PaymentDetailsListResponse}
     */
     ...
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/RegistrationFieldsResponse} and HTTP response
     */
    this.getRegistrationFieldsWithHttpInfo = function(opts) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = RegistrationFieldsResponse;
     ...
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/RegistrationFieldsResponse}
     */
     ...
     * Update customer
     * @param {Integer} customerId Customer ID to fetch
     * @param {module:model/UpdateCustomerRequest} body Body of the customer
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CustomerResponse} and HTTP response
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CredentialsValidationResponse} and HTTP response
     */
    this.validateCustomerCredentialsWithHttpInfo = function(email, password) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = CredentialsValidationResponse;
     ...
     * @param {String} email Customer email to validate
     * @param {String} password Customer password to check
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CredentialsValidationResponse}
     */
