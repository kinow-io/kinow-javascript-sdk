...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Cart', 'model/Customer', 'model/CustomerCreateRequest', 'model/SubscriptionAccesses', 'model/Address', 'model/Carts', 'model/CustomerCurrentViews', 'model/Groups', 'model/Orders', 'model/Customers', 'model/CustomerId', 'model/PaymentMethods', 'model/PaymentDetails', 'model/PrepaymentBalance', 'model/PrepaymentOperations', 'model/PaymentArguments'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Cart'), require('../model/Customer'), require('../model/CustomerCreateRequest'), require('../model/SubscriptionAccesses'), require('../model/Address'), require('../model/Carts'), require('../model/CustomerCurrentViews'), require('../model/Groups'), require('../model/Orders'), require('../model/Customers'), require('../model/CustomerId'), require('../model/PaymentMethods'), require('../model/PaymentDetails'), require('../model/PrepaymentBalance'), require('../model/PrepaymentOperations'), require('../model/PaymentArguments'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CustomersApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Cart, root.KinowJavascriptSdk.Customer, root.KinowJavascriptSdk.CustomerCreateRequest, root.KinowJavascriptSdk.SubscriptionAccesses, root.KinowJavascriptSdk.Address, root.KinowJavascriptSdk.Carts, root.KinowJavascriptSdk.CustomerCurrentViews, root.KinowJavascriptSdk.Groups, root.KinowJavascriptSdk.Orders, root.KinowJavascriptSdk.Customers, root.KinowJavascriptSdk.CustomerId, root.KinowJavascriptSdk.PaymentMethods, root.KinowJavascriptSdk.PaymentDetails, root.KinowJavascriptSdk.PrepaymentBalance, root.KinowJavascriptSdk.PrepaymentOperations, root.KinowJavascriptSdk.PaymentArguments);
  }
}(this, function(ApiClient, Cart, Customer, CustomerCreateRequest, SubscriptionAccesses, Address, Carts, CustomerCurrentViews, Groups, Orders, Customers, CustomerId, PaymentMethods, PaymentDetails, PrepaymentBalance, PrepaymentOperations, PaymentArguments) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} customerId Customer ID to fetch
     * @param {String} type PrepaymentBalance type to fetch (currency or credit)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PrepaymentBalance} and HTTP response
     */
    this.getPrepaymentBalancesWithHttpInfo = function(customerId, type) {
      var postBody = null;
      ...
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getPrepaymentBalances");
      }
      ...
      return this.apiClient.callApi(
        '/customers/{customer_id}/prepayment-balance/{type}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @param {Integer} customerId Customer ID to fetch
     * @param {String} type PrepaymentBalance type to fetch (currency or credit)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PrepaymentBalance}
     */
    this.getPrepaymentBalances = function(customerId, type) {
      return this.getPrepaymentBalancesWithHttpInfo(customerId, type)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
