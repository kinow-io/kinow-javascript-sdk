...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Cart', 'model/Customer', 'model/CustomerCreateRequest', 'model/SubscriptionAccesses', 'model/Address', 'model/CustomerCurrentViews', 'model/Groups', 'model/Orders', 'model/Customers', 'model/CustomerId', 'model/PaymentMethods', 'model/PaymentDetails', 'model/PaymentArguments'], factory);
...
}(this, function(ApiClient, Cart, Customer, CustomerCreateRequest, SubscriptionAccesses, Address, CustomerCurrentViews, Groups, Orders, Customers, CustomerId, PaymentMethods, PaymentDetails, PaymentArguments) {
  'use strict';
