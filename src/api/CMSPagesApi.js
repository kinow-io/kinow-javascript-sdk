...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CMSPage', 'model/CMSPageLists'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CMSPage'), require('../model/CMSPageLists'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CMSPagesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CMSPage, root.KinowJavascriptSdk.CMSPageLists);
  }
}(this, function(ApiClient, CMSPage, CMSPageLists) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Create cms page
     * @param {module:model/CMSPage} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CMSPage} and HTTP response
     */
     ...
     * Create cms page
     * @param {module:model/CMSPage} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CMSPage}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CMSPageLists} and HTTP response
     */
     ...
     * @param {String} opts.sortBy Sort by this attribute (id by default)
     * @param {module:model/String} opts.sortDirection Sorting direction (asc by default)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CMSPageLists}
     */
    ...
    /**
     * Update cms page
     * @param {Integer} cmsPageId ID of the page to update
     * @param {module:model/CMSPage} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CMSPage} and HTTP response
     */
