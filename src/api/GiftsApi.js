...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} token Gift token to fetch
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Gift} and HTTP response
     */
    this.getGiftByTokenWithHttpInfo = function(token) {
      var postBody = null;

      // verify the required parameter 'token' is set
      if (token === undefined || token === null) {
        throw new Error("Missing the required parameter 'token' when calling getGiftByToken");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Gift}
     */
    this.getGiftByToken = function(token) {
      return this.getGiftByTokenWithHttpInfo(token)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
