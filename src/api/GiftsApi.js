...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Gift', 'model/GiftToken', 'model/Gifts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Gift'), require('../model/GiftToken'), require('../model/Gifts'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.GiftsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Gift, root.KinowJavascriptSdk.GiftToken, root.KinowJavascriptSdk.Gifts);
  }
}(this, function(ApiClient, Gift, GiftToken, Gifts) {
  'use strict';
