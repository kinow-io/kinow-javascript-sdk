...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Gift', 'model/Gift1', 'model/GiftToken', 'model/Gifts1', 'model/Gift2'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Gift'), require('../model/Gift1'), require('../model/GiftToken'), require('../model/Gifts1'), require('../model/Gift2'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.GiftsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Gift, root.KinowJavascriptSdk.Gift1, root.KinowJavascriptSdk.GiftToken, root.KinowJavascriptSdk.Gifts1, root.KinowJavascriptSdk.Gift2);
  }
}(this, function(ApiClient, Gift, Gift1, GiftToken, Gifts1, Gift2) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * Get Gifts in cart
     * @param {Integer} cartId Cart ID to fetch
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/Gift>} and HTTP response
     */
     ...
     * Get Gifts in cart
     * @param {Integer} cartId Cart ID to fetch
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/Gift>}
     */
