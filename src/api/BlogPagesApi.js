...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BlogPage', 'model/Products', 'model/BlogPageLists'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BlogPage'), require('../model/Products'), require('../model/BlogPageLists'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.BlogPagesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.BlogPage, root.KinowJavascriptSdk.Products, root.KinowJavascriptSdk.BlogPageLists);
  }
}(this, function(ApiClient, BlogPage, Products, BlogPageLists) {
  'use strict';
