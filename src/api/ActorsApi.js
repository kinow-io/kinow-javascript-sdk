...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateActorRequest', 'model/ActorResponse', 'model/ImageResponse', 'model/ActorProductListResponse', 'model/ActorProductRoleListResponse', 'model/ActorListResponse', 'model/CategoryActorsResponse', 'model/ActorRoleListResponse', 'model/UpdateActorRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateActorRequest'), require('../model/ActorResponse'), require('../model/ImageResponse'), require('../model/ActorProductListResponse'), require('../model/ActorProductRoleListResponse'), require('../model/ActorListResponse'), require('../model/CategoryActorsResponse'), require('../model/ActorRoleListResponse'), require('../model/UpdateActorRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ActorsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CreateActorRequest, root.KinowJavascriptSdk.ActorResponse, root.KinowJavascriptSdk.ImageResponse, root.KinowJavascriptSdk.ActorProductListResponse, root.KinowJavascriptSdk.ActorProductRoleListResponse, root.KinowJavascriptSdk.ActorListResponse, root.KinowJavascriptSdk.CategoryActorsResponse, root.KinowJavascriptSdk.ActorRoleListResponse, root.KinowJavascriptSdk.UpdateActorRequest);
  }
}(this, function(ApiClient, CreateActorRequest, ActorResponse, ImageResponse, ActorProductListResponse, ActorProductRoleListResponse, ActorListResponse, CategoryActorsResponse, ActorRoleListResponse, UpdateActorRequest) {
  'use strict';
