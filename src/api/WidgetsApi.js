...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Image', 'model/GoogleAnalytics', 'model/WidgetFooterMenus', 'model/WidgetHomeRails', 'model/WidgetHookPhrases', 'model/WidgetSliders', 'model/WidgetSlider', 'model/WidgetTopMenus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Image'), require('../model/GoogleAnalytics'), require('../model/WidgetFooterMenus'), require('../model/WidgetHomeRails'), require('../model/WidgetHookPhrases'), require('../model/WidgetSliders'), require('../model/WidgetSlider'), require('../model/WidgetTopMenus'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.WidgetsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.GoogleAnalytics, root.KinowJavascriptSdk.WidgetFooterMenus, root.KinowJavascriptSdk.WidgetHomeRails, root.KinowJavascriptSdk.WidgetHookPhrases, root.KinowJavascriptSdk.WidgetSliders, root.KinowJavascriptSdk.WidgetSlider, root.KinowJavascriptSdk.WidgetTopMenus);
  }
}(this, function(ApiClient, Image, GoogleAnalytics, WidgetFooterMenus, WidgetHomeRails, WidgetHookPhrases, WidgetSliders, WidgetSlider, WidgetTopMenus) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/WidgetHomeRails} and HTTP response
     */
    this.getWidgetHomeRailWithHttpInfo = function(opts) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = WidgetHomeRails;
     ...
     * @param {Integer} opts.page 
     * @param {Integer} opts.perPage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/WidgetHomeRails}
     */
