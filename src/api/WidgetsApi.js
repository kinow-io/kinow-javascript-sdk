...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ImageListResponse', 'model/GoogleAnalyticsResponse', 'model/WidgetFooterMenuListResponse', 'model/WidgetHomeRailListResponse', 'model/WidgetHookPhraseListResponse', 'model/WidgetSliderListResponse', 'model/WidgetSliderResponse', 'model/WidgetTopMenuListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ImageListResponse'), require('../model/GoogleAnalyticsResponse'), require('../model/WidgetFooterMenuListResponse'), require('../model/WidgetHomeRailListResponse'), require('../model/WidgetHookPhraseListResponse'), require('../model/WidgetSliderListResponse'), require('../model/WidgetSliderResponse'), require('../model/WidgetTopMenuListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.WidgetsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.ImageListResponse, root.KinowJavascriptSdk.GoogleAnalyticsResponse, root.KinowJavascriptSdk.WidgetFooterMenuListResponse, root.KinowJavascriptSdk.WidgetHomeRailListResponse, root.KinowJavascriptSdk.WidgetHookPhraseListResponse, root.KinowJavascriptSdk.WidgetSliderListResponse, root.KinowJavascriptSdk.WidgetSliderResponse, root.KinowJavascriptSdk.WidgetTopMenuListResponse);
  }
}(this, function(ApiClient, ImageListResponse, GoogleAnalyticsResponse, WidgetFooterMenuListResponse, WidgetHomeRailListResponse, WidgetHookPhraseListResponse, WidgetSliderListResponse, WidgetSliderResponse, WidgetTopMenuListResponse) {
  'use strict';
