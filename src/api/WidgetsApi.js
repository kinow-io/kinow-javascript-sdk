...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Image', 'model/WidgetFooterMenus', 'model/WidgetSliders', 'model/WidgetTopMenus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Image'), require('../model/WidgetFooterMenus'), require('../model/WidgetSliders'), require('../model/WidgetTopMenus'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.WidgetsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.WidgetFooterMenus, root.KinowJavascriptSdk.WidgetSliders, root.KinowJavascriptSdk.WidgetTopMenus);
  }
}(this, function(ApiClient, Image, WidgetFooterMenus, WidgetSliders, WidgetTopMenus) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/Image>} and HTTP response
     */
    this.getSliderImagesWithHttpInfo = function() {
      var postBody = null;
    ...
    this.getSliderImages = function() {
      return this.getSliderImagesWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
