...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ImageListResponse', 'model/GoogleAnalyticsResponse', 'model/WidgetFooterMenuListResponse', 'model/WidgetHomeRailListResponse', 'model/WidgetHookPhraseListResponse', 'model/WidgetSliderListResponse', 'model/WidgetSliderResponse', 'model/Player', 'model/WidgetTopMenuListResponse'], factory);
    ...
    root.KinowJavascriptSdk.WidgetsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.ImageListResponse, root.KinowJavascriptSdk.GoogleAnalyticsResponse, root.KinowJavascriptSdk.WidgetFooterMenuListResponse, root.KinowJavascriptSdk.WidgetHomeRailListResponse, root.KinowJavascriptSdk.WidgetHookPhraseListResponse, root.KinowJavascriptSdk.WidgetSliderListResponse, root.KinowJavascriptSdk.WidgetSliderResponse, root.KinowJavascriptSdk.Player, root.KinowJavascriptSdk.WidgetTopMenuListResponse);
  }
}(this, function(ApiClient, ImageListResponse, GoogleAnalyticsResponse, WidgetFooterMenuListResponse, WidgetHomeRailListResponse, WidgetHookPhraseListResponse, WidgetSliderListResponse, WidgetSliderResponse, Player, WidgetTopMenuListResponse) {
  'use strict';
