...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Product', 'model/Products', 'model/ProductAccessInfo', 'model/ProductIDList', 'model/Actors', 'model/ProductAttributesResponse', 'model/Categories', 'model/Image', 'model/Directors', 'model/Videos1', 'model/Features', 'model/Geolocs', 'model/Groups', 'model/ProductImagesResponse', 'model/Subscription', 'model/Videos2'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Product'), require('../model/Products'), require('../model/ProductAccessInfo'), require('../model/ProductIDList'), require('../model/Actors'), require('../model/ProductAttributesResponse'), require('../model/Categories'), require('../model/Image'), require('../model/Directors'), require('../model/Videos1'), require('../model/Features'), require('../model/Geolocs'), require('../model/Groups'), require('../model/ProductImagesResponse'), require('../model/Subscription'), require('../model/Videos2'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ProductsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Product, root.KinowJavascriptSdk.Products, root.KinowJavascriptSdk.ProductAccessInfo, root.KinowJavascriptSdk.ProductIDList, root.KinowJavascriptSdk.Actors, root.KinowJavascriptSdk.ProductAttributesResponse, root.KinowJavascriptSdk.Categories, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.Directors, root.KinowJavascriptSdk.Videos1, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.Groups, root.KinowJavascriptSdk.ProductImagesResponse, root.KinowJavascriptSdk.Subscription, root.KinowJavascriptSdk.Videos2);
  }
}(this, function(ApiClient, Product, Products, ProductAccessInfo, ProductIDList, Actors, ProductAttributesResponse, Categories, Image, Directors, Videos1, Features, Geolocs, Groups, ProductImagesResponse, Subscription, Videos2) {
  'use strict';
