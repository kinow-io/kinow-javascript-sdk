...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateProductRequest', 'model/ProductResponse', 'model/CreateCommentRequest', 'model/ProductCommentResponse', 'model/ProductListResponse', 'model/ProductIDList', 'model/ProductAccessInfoResponse', 'model/BlogPageProductsResponse', 'model/ProductPrice', 'model/ProductIDList1', 'model/ActorListResponse', 'model/ActorRoleListResponse', 'model/ProductAttributeListResponse', 'model/CategoryListResponse', 'model/ProductCommentListResponse1', 'model/ImageResponse', 'model/DirectorListResponse', 'model/DirectorRoleListResponse', 'model/ExtractListResponse', 'model/FeatureListResponse', 'model/GeolocationListResponse', 'model/GroupListResponse', 'model/ImageListResponse', 'model/Image', 'model/SubscriptionResponse', 'model/VideoGroupListResponse', 'model/ProductVideoListResponse', 'model/UpdateProductRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateProductRequest'), require('../model/ProductResponse'), require('../model/CreateCommentRequest'), require('../model/ProductCommentResponse'), require('../model/ProductListResponse'), require('../model/ProductIDList'), require('../model/ProductAccessInfoResponse'), require('../model/BlogPageProductsResponse'), require('../model/ProductPrice'), require('../model/ProductIDList1'), require('../model/ActorListResponse'), require('../model/ActorRoleListResponse'), require('../model/ProductAttributeListResponse'), require('../model/CategoryListResponse'), require('../model/ProductCommentListResponse1'), require('../model/ImageResponse'), require('../model/DirectorListResponse'), require('../model/DirectorRoleListResponse'), require('../model/ExtractListResponse'), require('../model/FeatureListResponse'), require('../model/GeolocationListResponse'), require('../model/GroupListResponse'), require('../model/ImageListResponse'), require('../model/Image'), require('../model/SubscriptionResponse'), require('../model/VideoGroupListResponse'), require('../model/ProductVideoListResponse'), require('../model/UpdateProductRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ProductsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CreateProductRequest, root.KinowJavascriptSdk.ProductResponse, root.KinowJavascriptSdk.CreateCommentRequest, root.KinowJavascriptSdk.ProductCommentResponse, root.KinowJavascriptSdk.ProductListResponse, root.KinowJavascriptSdk.ProductIDList, root.KinowJavascriptSdk.ProductAccessInfoResponse, root.KinowJavascriptSdk.BlogPageProductsResponse, root.KinowJavascriptSdk.ProductPrice, root.KinowJavascriptSdk.ProductIDList1, root.KinowJavascriptSdk.ActorListResponse, root.KinowJavascriptSdk.ActorRoleListResponse, root.KinowJavascriptSdk.ProductAttributeListResponse, root.KinowJavascriptSdk.CategoryListResponse, root.KinowJavascriptSdk.ProductCommentListResponse1, root.KinowJavascriptSdk.ImageResponse, root.KinowJavascriptSdk.DirectorListResponse, root.KinowJavascriptSdk.DirectorRoleListResponse, root.KinowJavascriptSdk.ExtractListResponse, root.KinowJavascriptSdk.FeatureListResponse, root.KinowJavascriptSdk.GeolocationListResponse, root.KinowJavascriptSdk.GroupListResponse, root.KinowJavascriptSdk.ImageListResponse, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.SubscriptionResponse, root.KinowJavascriptSdk.VideoGroupListResponse, root.KinowJavascriptSdk.ProductVideoListResponse, root.KinowJavascriptSdk.UpdateProductRequest);
  }
}(this, function(ApiClient, CreateProductRequest, ProductResponse, CreateCommentRequest, ProductCommentResponse, ProductListResponse, ProductIDList, ProductAccessInfoResponse, BlogPageProductsResponse, ProductPrice, ProductIDList1, ActorListResponse, ActorRoleListResponse, ProductAttributeListResponse, CategoryListResponse, ProductCommentListResponse1, ImageResponse, DirectorListResponse, DirectorRoleListResponse, ExtractListResponse, FeatureListResponse, GeolocationListResponse, GroupListResponse, ImageListResponse, Image, SubscriptionResponse, VideoGroupListResponse, ProductVideoListResponse, UpdateProductRequest) {
  'use strict';
