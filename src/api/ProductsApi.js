...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Product', 'model/Products', 'model/Actors', 'model/ProductAttributesResponse', 'model/Categories', 'model/Image', 'model/Directors', 'model/Videos', 'model/Features', 'model/Geolocs', 'model/Groups', 'model/ProductImagesResponse', 'model/Subscription', 'model/Videos1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Product'), require('../model/Products'), require('../model/Actors'), require('../model/ProductAttributesResponse'), require('../model/Categories'), require('../model/Image'), require('../model/Directors'), require('../model/Videos'), require('../model/Features'), require('../model/Geolocs'), require('../model/Groups'), require('../model/ProductImagesResponse'), require('../model/Subscription'), require('../model/Videos1'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ProductsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Product, root.KinowJavascriptSdk.Products, root.KinowJavascriptSdk.Actors, root.KinowJavascriptSdk.ProductAttributesResponse, root.KinowJavascriptSdk.Categories, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.Directors, root.KinowJavascriptSdk.Videos, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.Groups, root.KinowJavascriptSdk.ProductImagesResponse, root.KinowJavascriptSdk.Subscription, root.KinowJavascriptSdk.Videos1);
  }
}(this, function(ApiClient, Product, Products, Actors, ProductAttributesResponse, Categories, Image, Directors, Videos, Features, Geolocs, Groups, ProductImagesResponse, Subscription, Videos1) {
  'use strict';
