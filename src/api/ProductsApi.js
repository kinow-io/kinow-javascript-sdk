...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Product', 'model/Products', 'model/ProductAccessInfo', 'model/ProductIDList', 'model/ProductPrice', 'model/ProductIDList1', 'model/Actors', 'model/ProductAttributesResponse', 'model/Categories', 'model/Image', 'model/CategoryDirectorsResponse', 'model/Videos1', 'model/Features', 'model/Geolocs', 'model/Groups', 'model/CategoryImagesResponse', 'model/Subscription', 'model/VideoGroup1', 'model/Videos2'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Product'), require('../model/Products'), require('../model/ProductAccessInfo'), require('../model/ProductIDList'), require('../model/ProductPrice'), require('../model/ProductIDList1'), require('../model/Actors'), require('../model/ProductAttributesResponse'), require('../model/Categories'), require('../model/Image'), require('../model/CategoryDirectorsResponse'), require('../model/Videos1'), require('../model/Features'), require('../model/Geolocs'), require('../model/Groups'), require('../model/CategoryImagesResponse'), require('../model/Subscription'), require('../model/VideoGroup1'), require('../model/Videos2'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ProductsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Product, root.KinowJavascriptSdk.Products, root.KinowJavascriptSdk.ProductAccessInfo, root.KinowJavascriptSdk.ProductIDList, root.KinowJavascriptSdk.ProductPrice, root.KinowJavascriptSdk.ProductIDList1, root.KinowJavascriptSdk.Actors, root.KinowJavascriptSdk.ProductAttributesResponse, root.KinowJavascriptSdk.Categories, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.CategoryDirectorsResponse, root.KinowJavascriptSdk.Videos1, root.KinowJavascriptSdk.Features, root.KinowJavascriptSdk.Geolocs, root.KinowJavascriptSdk.Groups, root.KinowJavascriptSdk.CategoryImagesResponse, root.KinowJavascriptSdk.Subscription, root.KinowJavascriptSdk.VideoGroup1, root.KinowJavascriptSdk.Videos2);
  }
}(this, function(ApiClient, Product, Products, ProductAccessInfo, ProductIDList, ProductPrice, ProductIDList1, Actors, ProductAttributesResponse, Categories, Image, CategoryDirectorsResponse, Videos1, Features, Geolocs, Groups, CategoryImagesResponse, Subscription, VideoGroup1, Videos2) {
  'use strict';
