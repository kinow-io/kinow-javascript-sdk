...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateProductRequest', 'model/ProductResponse', 'model/ProductListResponse', 'model/ProductIDList', 'model/ProductAccessInfoResponse', 'model/BlogPageProductsResponse', 'model/CartPriceResponse', 'model/ProductIDList1', 'model/ActorListResponse', 'model/ActorRoleListResponse', 'model/ProductAttributeListResponse', 'model/CategoryListResponse', 'model/ImageResponse', 'model/DirectorListResponse', 'model/DirectorRoleListResponse', 'model/ExtractListResponse', 'model/FeatureListResponse', 'model/GeolocationListResponse', 'model/GroupListResponse', 'model/ImageListResponse', 'model/Image', 'model/SubscriptionResponse', 'model/VideoGroupListResponse', 'model/ProductVideoListResponse', 'model/UpdateProductRequest', 'model/UploadProductCoverRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateProductRequest'), require('../model/ProductResponse'), require('../model/ProductListResponse'), require('../model/ProductIDList'), require('../model/ProductAccessInfoResponse'), require('../model/BlogPageProductsResponse'), require('../model/CartPriceResponse'), require('../model/ProductIDList1'), require('../model/ActorListResponse'), require('../model/ActorRoleListResponse'), require('../model/ProductAttributeListResponse'), require('../model/CategoryListResponse'), require('../model/ImageResponse'), require('../model/DirectorListResponse'), require('../model/DirectorRoleListResponse'), require('../model/ExtractListResponse'), require('../model/FeatureListResponse'), require('../model/GeolocationListResponse'), require('../model/GroupListResponse'), require('../model/ImageListResponse'), require('../model/Image'), require('../model/SubscriptionResponse'), require('../model/VideoGroupListResponse'), require('../model/ProductVideoListResponse'), require('../model/UpdateProductRequest'), require('../model/UploadProductCoverRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ProductsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CreateProductRequest, root.KinowJavascriptSdk.ProductResponse, root.KinowJavascriptSdk.ProductListResponse, root.KinowJavascriptSdk.ProductIDList, root.KinowJavascriptSdk.ProductAccessInfoResponse, root.KinowJavascriptSdk.BlogPageProductsResponse, root.KinowJavascriptSdk.CartPriceResponse, root.KinowJavascriptSdk.ProductIDList1, root.KinowJavascriptSdk.ActorListResponse, root.KinowJavascriptSdk.ActorRoleListResponse, root.KinowJavascriptSdk.ProductAttributeListResponse, root.KinowJavascriptSdk.CategoryListResponse, root.KinowJavascriptSdk.ImageResponse, root.KinowJavascriptSdk.DirectorListResponse, root.KinowJavascriptSdk.DirectorRoleListResponse, root.KinowJavascriptSdk.ExtractListResponse, root.KinowJavascriptSdk.FeatureListResponse, root.KinowJavascriptSdk.GeolocationListResponse, root.KinowJavascriptSdk.GroupListResponse, root.KinowJavascriptSdk.ImageListResponse, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.SubscriptionResponse, root.KinowJavascriptSdk.VideoGroupListResponse, root.KinowJavascriptSdk.ProductVideoListResponse, root.KinowJavascriptSdk.UpdateProductRequest, root.KinowJavascriptSdk.UploadProductCoverRequest);
  }
}(this, function(ApiClient, CreateProductRequest, ProductResponse, ProductListResponse, ProductIDList, ProductAccessInfoResponse, BlogPageProductsResponse, CartPriceResponse, ProductIDList1, ActorListResponse, ActorRoleListResponse, ProductAttributeListResponse, CategoryListResponse, ImageResponse, DirectorListResponse, DirectorRoleListResponse, ExtractListResponse, FeatureListResponse, GeolocationListResponse, GroupListResponse, ImageListResponse, Image, SubscriptionResponse, VideoGroupListResponse, ProductVideoListResponse, UpdateProductRequest, UploadProductCoverRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/UploadProductCoverRequest} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ImageResponse} and HTTP response
     */
    this.uploadProductCoverWithHttpInfo = function(body) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling uploadProductCover");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ImageResponse}
     */
    this.uploadProductCover = function(body) {
      return this.uploadProductCoverWithHttpInfo(body)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
