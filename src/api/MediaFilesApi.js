...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MediaFile', 'model/MediaFiles'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/MediaFile'), require('../model/MediaFiles'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.MediaFilesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.MediaFile, root.KinowJavascriptSdk.MediaFiles);
  }
}(this, function(ApiClient, MediaFile, MediaFiles) {
  'use strict';
