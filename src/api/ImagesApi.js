...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ImageResponse', 'model/ImageType', 'model/CategoryImagesResponse', 'model/ImageListResponse', 'model/Image', 'model/UploadActorCoverRequest', 'model/UploadCategoryCoverRequest', 'model/UploadDirectorCoverRequest', 'model/UploadProductCoverRequest', 'model/UploadSubscriptionCoverRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ImageResponse'), require('../model/ImageType'), require('../model/CategoryImagesResponse'), require('../model/ImageListResponse'), require('../model/Image'), require('../model/UploadActorCoverRequest'), require('../model/UploadCategoryCoverRequest'), require('../model/UploadDirectorCoverRequest'), require('../model/UploadProductCoverRequest'), require('../model/UploadSubscriptionCoverRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ImagesApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.ImageResponse, root.KinowJavascriptSdk.ImageType, root.KinowJavascriptSdk.CategoryImagesResponse, root.KinowJavascriptSdk.ImageListResponse, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.UploadActorCoverRequest, root.KinowJavascriptSdk.UploadCategoryCoverRequest, root.KinowJavascriptSdk.UploadDirectorCoverRequest, root.KinowJavascriptSdk.UploadProductCoverRequest, root.KinowJavascriptSdk.UploadSubscriptionCoverRequest);
  }
}(this, function(ApiClient, ImageResponse, ImageType, CategoryImagesResponse, ImageListResponse, Image, UploadActorCoverRequest, UploadCategoryCoverRequest, UploadDirectorCoverRequest, UploadProductCoverRequest, UploadSubscriptionCoverRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Upload actor cover
     * @param {module:model/UploadActorCoverRequest} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ImageResponse} and HTTP response
     */
    this.uploadActorCoverWithHttpInfo = function(body) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling uploadActorCover");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ImageResponse}
     */
    this.uploadActorCover = function(body) {
      return this.uploadActorCoverWithHttpInfo(body)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     * @param {module:model/UploadDirectorCoverRequest} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Image} and HTTP response
     */
    this.uploadDirectorCoverWithHttpInfo = function(body) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling uploadDirectorCover");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Image}
     */
    this.uploadDirectorCover = function(body) {
      return this.uploadDirectorCoverWithHttpInfo(body)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     * @param {module:model/UploadSubscriptionCoverRequest} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ImageResponse} and HTTP response
     */
    this.uploadSubscriptionCoverWithHttpInfo = function(body) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling uploadSubscriptionCover");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ImageResponse}
     */
    this.uploadSubscriptionCover = function(body) {
      return this.uploadSubscriptionCoverWithHttpInfo(body)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
