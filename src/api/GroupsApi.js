...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateGroupRequest', 'model/GroupResponse', 'model/GroupListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateGroupRequest'), require('../model/GroupResponse'), require('../model/GroupListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.GroupsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CreateGroupRequest, root.KinowJavascriptSdk.GroupResponse, root.KinowJavascriptSdk.GroupListResponse);
  }
}(this, function(ApiClient, CreateGroupRequest, GroupResponse, GroupListResponse) {
  'use strict';
