...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PrepaymentBalance', 'model/PrepaymentOperations', 'model/PrepaymentBonus', 'model/PrepaymentBonusIDList', 'model/PrepaymentBonusAmount', 'model/PrepaymentBonus1', 'model/PrepaymentOperation', 'model/PrepaymentOperationIDList', 'model/PrepaymentOperationAmount', 'model/PrepaymentRecharge', 'model/PrepaymentRecharges'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PrepaymentBalance'), require('../model/PrepaymentOperations'), require('../model/PrepaymentBonus'), require('../model/PrepaymentBonusIDList'), require('../model/PrepaymentBonusAmount'), require('../model/PrepaymentBonus1'), require('../model/PrepaymentOperation'), require('../model/PrepaymentOperationIDList'), require('../model/PrepaymentOperationAmount'), require('../model/PrepaymentRecharge'), require('../model/PrepaymentRecharges'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.PrepaymentsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.PrepaymentBalance, root.KinowJavascriptSdk.PrepaymentOperations, root.KinowJavascriptSdk.PrepaymentBonus, root.KinowJavascriptSdk.PrepaymentBonusIDList, root.KinowJavascriptSdk.PrepaymentBonusAmount, root.KinowJavascriptSdk.PrepaymentBonus1, root.KinowJavascriptSdk.PrepaymentOperation, root.KinowJavascriptSdk.PrepaymentOperationIDList, root.KinowJavascriptSdk.PrepaymentOperationAmount, root.KinowJavascriptSdk.PrepaymentRecharge, root.KinowJavascriptSdk.PrepaymentRecharges);
  }
}(this, function(ApiClient, PrepaymentBalance, PrepaymentOperations, PrepaymentBonus, PrepaymentBonusIDList, PrepaymentBonusAmount, PrepaymentBonus1, PrepaymentOperation, PrepaymentOperationIDList, PrepaymentOperationAmount, PrepaymentRecharge, PrepaymentRecharges) {
  'use strict';
