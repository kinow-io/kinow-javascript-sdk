...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PrepaymentBalance', 'model/PrepaymentOperations', 'model/PrepaymentBonus1', 'model/PrepaymentBonus', 'model/PrepaymentOperation', 'model/PrepaymentRecharge', 'model/PrepaymentRecharges'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PrepaymentBalance'), require('../model/PrepaymentOperations'), require('../model/PrepaymentBonus1'), require('../model/PrepaymentBonus'), require('../model/PrepaymentOperation'), require('../model/PrepaymentRecharge'), require('../model/PrepaymentRecharges'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.PrepaymentsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.PrepaymentBalance, root.KinowJavascriptSdk.PrepaymentOperations, root.KinowJavascriptSdk.PrepaymentBonus1, root.KinowJavascriptSdk.PrepaymentBonus, root.KinowJavascriptSdk.PrepaymentOperation, root.KinowJavascriptSdk.PrepaymentRecharge, root.KinowJavascriptSdk.PrepaymentRecharges);
  }
}(this, function(ApiClient, PrepaymentBalance, PrepaymentOperations, PrepaymentBonus1, PrepaymentBonus, PrepaymentOperation, PrepaymentRecharge, PrepaymentRecharges) {
  'use strict';
