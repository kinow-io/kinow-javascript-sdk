...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Cart', 'model/Cart1', 'model/Carts', 'model/PaymentUrl', 'model/CartPrice', 'model/CartIDList', 'model/PaymentDetails1', 'model/Cart2', 'model/PaymentArguments'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Cart'), require('../model/Cart1'), require('../model/Carts'), require('../model/PaymentUrl'), require('../model/CartPrice'), require('../model/CartIDList'), require('../model/PaymentDetails1'), require('../model/Cart2'), require('../model/PaymentArguments'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CartsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Cart, root.KinowJavascriptSdk.Cart1, root.KinowJavascriptSdk.Carts, root.KinowJavascriptSdk.PaymentUrl, root.KinowJavascriptSdk.CartPrice, root.KinowJavascriptSdk.CartIDList, root.KinowJavascriptSdk.PaymentDetails1, root.KinowJavascriptSdk.Cart2, root.KinowJavascriptSdk.PaymentArguments);
  }
}(this, function(ApiClient, Cart, Cart1, Carts, PaymentUrl, CartPrice, CartIDList, PaymentDetails1, Cart2, PaymentArguments) {
  'use strict';
