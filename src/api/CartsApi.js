...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Cart', 'model/Cart1', 'model/PaymentModules', 'model/Carts', 'model/PaymentUrl', 'model/CartPrice', 'model/CartIDList', 'model/PaymentDetails1', 'model/PaymentArguments', 'model/Cart2'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Cart'), require('../model/Cart1'), require('../model/PaymentModules'), require('../model/Carts'), require('../model/PaymentUrl'), require('../model/CartPrice'), require('../model/CartIDList'), require('../model/PaymentDetails1'), require('../model/PaymentArguments'), require('../model/Cart2'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CartsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.Cart, root.KinowJavascriptSdk.Cart1, root.KinowJavascriptSdk.PaymentModules, root.KinowJavascriptSdk.Carts, root.KinowJavascriptSdk.PaymentUrl, root.KinowJavascriptSdk.CartPrice, root.KinowJavascriptSdk.CartIDList, root.KinowJavascriptSdk.PaymentDetails1, root.KinowJavascriptSdk.PaymentArguments, root.KinowJavascriptSdk.Cart2);
  }
}(this, function(ApiClient, Cart, Cart1, PaymentModules, Carts, PaymentUrl, CartPrice, CartIDList, PaymentDetails1, PaymentArguments, Cart2) {
  'use strict';
