...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddProductToCartRequest', 'model/CartResponse', 'model/CreateCartRequest', 'model/PaymentModuleListResponse1', 'model/CartListResponse1', 'model/CartListResponse', 'model/PaymentUrlResponse', 'model/CartPrice', 'model/CartIDList', 'model/PaymentDetailsResponse', 'model/PaymentArguments', 'model/UpdateCartRequest', 'model/PaymentArgumentsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AddProductToCartRequest'), require('../model/CartResponse'), require('../model/CreateCartRequest'), require('../model/PaymentModuleListResponse1'), require('../model/CartListResponse1'), require('../model/CartListResponse'), require('../model/PaymentUrlResponse'), require('../model/CartPrice'), require('../model/CartIDList'), require('../model/PaymentDetailsResponse'), require('../model/PaymentArguments'), require('../model/UpdateCartRequest'), require('../model/PaymentArgumentsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.CartsApi = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.AddProductToCartRequest, root.KinowJavascriptSdk.CartResponse, root.KinowJavascriptSdk.CreateCartRequest, root.KinowJavascriptSdk.PaymentModuleListResponse1, root.KinowJavascriptSdk.CartListResponse1, root.KinowJavascriptSdk.CartListResponse, root.KinowJavascriptSdk.PaymentUrlResponse, root.KinowJavascriptSdk.CartPrice, root.KinowJavascriptSdk.CartIDList, root.KinowJavascriptSdk.PaymentDetailsResponse, root.KinowJavascriptSdk.PaymentArguments, root.KinowJavascriptSdk.UpdateCartRequest, root.KinowJavascriptSdk.PaymentArgumentsResponse);
  }
}(this, function(ApiClient, AddProductToCartRequest, CartResponse, CreateCartRequest, PaymentModuleListResponse1, CartListResponse1, CartListResponse, PaymentUrlResponse, CartPrice, CartIDList, PaymentDetailsResponse, PaymentArguments, UpdateCartRequest, PaymentArgumentsResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CartListResponse1} and HTTP response
     */
    this.getCartsWithHttpInfo = function(opts) {
      ...
      var contentTypes = [];
      var accepts = [];
      var returnType = CartListResponse1;
     ...
     * @param {String} opts.sortBy Sort by this attribute (id by default)
     * @param {module:model/String} opts.sortDirection Sorting direction (asc by default)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CartListResponse1}
     */
