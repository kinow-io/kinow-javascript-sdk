...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.addProductToCartWithHttpInfo = function(cartId, productId, ipAddress, opts) {
      opts = opts || {};
      var postBody = null;
      ...
      if (ipAddress === undefined || ipAddress === null) {
        throw new Error("Missing the required parameter 'ipAddress' when calling addProductToCart");
      }
     ...
     */
    this.addProductToCart = function(cartId, productId, ipAddress, opts) {
      return this.addProductToCartWithHttpInfo(cartId, productId, ipAddress, opts)
