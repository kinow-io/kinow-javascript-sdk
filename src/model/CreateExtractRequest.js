...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CreateExtractRequest = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The CreateExtractRequest model module.
   * @module model/CreateExtractRequest
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>CreateExtractRequest</code>.
   * @alias module:model/CreateExtractRequest
   * @class
   * @param filename {String} 
   * @param name {Array.<module:model/I18nField>} 
   */
  var exports = function(filename, name) {
    var _this = this;
  ...
  /**
   * Constructs a <code>CreateExtractRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateExtractRequest} obj Optional instance to populate.
   * @return {module:model/CreateExtractRequest} The populated <code>CreateExtractRequest</code> instance.
   */
