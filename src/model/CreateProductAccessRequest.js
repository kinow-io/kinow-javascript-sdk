...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CreateProductAccessRequest = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The CreateProductAccessRequest model module.
   * @module model/CreateProductAccessRequest
   * @version 1.5.1
   */

  /**
   * Constructs a new <code>CreateProductAccessRequest</code>.
   * @alias module:model/CreateProductAccessRequest
   * @class
   * @param idCustomer {Integer} 
   * @param idProduct {Integer} 
   */
  var exports = function(idCustomer, idProduct) {
    var _this = this;
  ...
  /**
   * Constructs a <code>CreateProductAccessRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateProductAccessRequest} obj Optional instance to populate.
   * @return {module:model/CreateProductAccessRequest} The populated <code>CreateProductAccessRequest</code> instance.
   */
