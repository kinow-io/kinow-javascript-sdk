...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CartProduct = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.ProductAttribute, root.KinowJavascriptSdk.ProductCategories, root.KinowJavascriptSdk.Tag);
  }
  ...
  /**
   * The CartProduct model module.
   * @module model/CartProduct
   * @version 1.4.56
   */

  /**
   * Constructs a new <code>CartProduct</code>.
   * @alias module:model/CartProduct
   * @class
   */
  ...
  /**
   * Constructs a <code>CartProduct</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CartProduct} obj Optional instance to populate.
   * @return {module:model/CartProduct} The populated <code>CartProduct</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('id_gift')) {
        obj['id_gift'] = ApiClient.convertToType(data['id_gift'], 'Integer');
      }
  ...
  /**
   * @member {Integer} id_gift
   */
  exports.prototype['id_gift'] = undefined;
  /**
   * @member {Integer} id
   */
