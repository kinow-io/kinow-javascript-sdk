...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.DirectorProductRole = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.ProductAttribute, root.KinowJavascriptSdk.ProductCategories, root.KinowJavascriptSdk.Tag);
  }
  ...
  /**
   * The DirectorProductRole model module.
   * @module model/DirectorProductRole
   * @version 1.5.0
   */

  /**
   * Constructs a new <code>DirectorProductRole</code>.
   * @alias module:model/DirectorProductRole
   * @class
   */
  ...
  /**
   * Constructs a <code>DirectorProductRole</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DirectorProductRole} obj Optional instance to populate.
   * @return {module:model/DirectorProductRole} The populated <code>DirectorProductRole</code> instance.
   */
