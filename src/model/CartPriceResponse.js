...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CartPriceResponse = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.TaxPrice);
  }
  ...
  /**
   * The CartPriceResponse model module.
   * @module model/CartPriceResponse
   * @version 1.5.0
   */

  /**
   * Constructs a new <code>CartPriceResponse</code>.
   * @alias module:model/CartPriceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CartPriceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CartPriceResponse} obj Optional instance to populate.
   * @return {module:model/CartPriceResponse} The populated <code>CartPriceResponse</code> instance.
   */
