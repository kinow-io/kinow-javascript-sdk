...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CreateVideoSubtitleRequest = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The CreateVideoSubtitleRequest model module.
   * @module model/CreateVideoSubtitleRequest
   * @version 1.4.46
   */

  /**
   * Constructs a new <code>CreateVideoSubtitleRequest</code>.
   * @alias module:model/CreateVideoSubtitleRequest
   * @class
  ...
  /**
   * Constructs a <code>CreateVideoSubtitleRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateVideoSubtitleRequest} obj Optional instance to populate.
   * @return {module:model/CreateVideoSubtitleRequest} The populated <code>CreateVideoSubtitleRequest</code> instance.
   */
