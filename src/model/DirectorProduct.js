...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.DirectorProduct = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.ProductAttribute, root.KinowJavascriptSdk.ProductCategories, root.KinowJavascriptSdk.Tag);
  }
  ...
  /**
   * The DirectorProduct model module.
   * @module model/DirectorProduct
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>DirectorProduct</code>.
   * @alias module:model/DirectorProduct
   * @class
   */
  ...
  /**
   * Constructs a <code>DirectorProduct</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DirectorProduct} obj Optional instance to populate.
   * @return {module:model/DirectorProduct} The populated <code>DirectorProduct</code> instance.
   */
