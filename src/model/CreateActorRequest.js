...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CreateActorRequest = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nFieldInput);
  }
  ...
  /**
   * The CreateActorRequest model module.
   * @module model/CreateActorRequest
   * @version 2.0.17
   */

  /**
   * Constructs a new <code>CreateActorRequest</code>.
   * @alias module:model/CreateActorRequest
   * @class
   * @param name {String} 
  ...
  /**
   * Constructs a <code>CreateActorRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateActorRequest} obj Optional instance to populate.
   * @return {module:model/CreateActorRequest} The populated <code>CreateActorRequest</code> instance.
   */
