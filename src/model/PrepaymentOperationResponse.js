...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.PrepaymentOperationResponse = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The PrepaymentOperationResponse model module.
   * @module model/PrepaymentOperationResponse
   * @version 2.0.14
   */

  /**
   * Constructs a new <code>PrepaymentOperationResponse</code>.
   * @alias module:model/PrepaymentOperationResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PrepaymentOperationResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PrepaymentOperationResponse} obj Optional instance to populate.
   * @return {module:model/PrepaymentOperationResponse} The populated <code>PrepaymentOperationResponse</code> instance.
   */
