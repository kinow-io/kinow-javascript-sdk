...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.UpdateVideoRequest = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.VideoFreeAccess);
  }
  ...
  /**
   * The UpdateVideoRequest model module.
   * @module model/UpdateVideoRequest
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>UpdateVideoRequest</code>.
   * @alias module:model/UpdateVideoRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateVideoRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateVideoRequest} obj Optional instance to populate.
   * @return {module:model/UpdateVideoRequest} The populated <code>UpdateVideoRequest</code> instance.
   */
