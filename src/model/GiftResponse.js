...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.GiftResponse = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The GiftResponse model module.
   * @module model/GiftResponse
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>GiftResponse</code>.
   * @alias module:model/GiftResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GiftResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GiftResponse} obj Optional instance to populate.
   * @return {module:model/GiftResponse} The populated <code>GiftResponse</code> instance.
   */
