...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.UpdateCMSCategoryRequest = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The UpdateCMSCategoryRequest model module.
   * @module model/UpdateCMSCategoryRequest
   * @version 2.0.20
   */

  /**
   * Constructs a new <code>UpdateCMSCategoryRequest</code>.
   * @alias module:model/UpdateCMSCategoryRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateCMSCategoryRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateCMSCategoryRequest} obj Optional instance to populate.
   * @return {module:model/UpdateCMSCategoryRequest} The populated <code>UpdateCMSCategoryRequest</code> instance.
   */
