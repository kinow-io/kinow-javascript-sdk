...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.UpdateCartRuleRequest = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CartRuleRestrictionGroup, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The UpdateCartRuleRequest model module.
   * @module model/UpdateCartRuleRequest
   * @version 2.0.28
   */

  /**
   * Constructs a new <code>UpdateCartRuleRequest</code>.
   * @alias module:model/UpdateCartRuleRequest
   * @class
   * @param name {Array.<module:model/I18nField>} This will be displayed in the cart summary, as well as on the invoice
   */
  ...
  /**
   * Constructs a <code>UpdateCartRuleRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateCartRuleRequest} obj Optional instance to populate.
   * @return {module:model/UpdateCartRuleRequest} The populated <code>UpdateCartRuleRequest</code> instance.
   */
