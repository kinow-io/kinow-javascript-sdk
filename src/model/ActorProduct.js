...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.ActorProduct = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.ProductAttribute, root.KinowJavascriptSdk.ProductCategories, root.KinowJavascriptSdk.Tag);
  }
  ...
  /**
   * The ActorProduct model module.
   * @module model/ActorProduct
   * @version 1.5.0
   */

  /**
   * Constructs a new <code>ActorProduct</code>.
   * @alias module:model/ActorProduct
   * @class
   */
  ...
  /**
   * Constructs a <code>ActorProduct</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActorProduct} obj Optional instance to populate.
   * @return {module:model/ActorProduct} The populated <code>ActorProduct</code> instance.
   */
