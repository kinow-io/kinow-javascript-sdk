...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CreateCartRuleRequest = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.CartRuleRestrictionGroup, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The CreateCartRuleRequest model module.
   * @module model/CreateCartRuleRequest
   * @version 2.0.3
   */

  /**
   * Constructs a new <code>CreateCartRuleRequest</code>.
   * @alias module:model/CreateCartRuleRequest
   * @class
  ...
  /**
   * Constructs a <code>CreateCartRuleRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateCartRuleRequest} obj Optional instance to populate.
   * @return {module:model/CreateCartRuleRequest} The populated <code>CreateCartRuleRequest</code> instance.
   */
