...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.ExtractResponse = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The ExtractResponse model module.
   * @module model/ExtractResponse
   * @version 2.0.2
   */

  /**
   * Constructs a new <code>ExtractResponse</code>.
   * @alias module:model/ExtractResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ExtractResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExtractResponse} obj Optional instance to populate.
   * @return {module:model/ExtractResponse} The populated <code>ExtractResponse</code> instance.
   */
