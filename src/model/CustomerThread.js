...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CustomerThread = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The CustomerThread model module.
   * @module model/CustomerThread
   * @version 1.3.52
   */

  /**
   * Constructs a new <code>CustomerThread</code>.
   * @alias module:model/CustomerThread
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomerThread</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomerThread} obj Optional instance to populate.
   * @return {module:model/CustomerThread} The populated <code>CustomerThread</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('id_land')) {
        obj['id_land'] = ApiClient.convertToType(data['id_land'], 'Integer');
      }
  ...
  /**
   * 
   * @member {Integer} id_land
   */
  exports.prototype['id_land'] = undefined;
  /**
   * 
