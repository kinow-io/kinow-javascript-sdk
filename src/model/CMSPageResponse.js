...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CMSPageResponse = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The CMSPageResponse model module.
   * @module model/CMSPageResponse
   * @version 2.0.14
   */

  /**
   * Constructs a new <code>CMSPageResponse</code>.
   * @alias module:model/CMSPageResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CMSPageResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CMSPageResponse} obj Optional instance to populate.
   * @return {module:model/CMSPageResponse} The populated <code>CMSPageResponse</code> instance.
   */
