...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.ProductAccessResponse = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The ProductAccessResponse model module.
   * @module model/ProductAccessResponse
   * @version 2.0.24
   */

  /**
   * Constructs a new <code>ProductAccessResponse</code>.
   * @alias module:model/ProductAccessResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ProductAccessResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductAccessResponse} obj Optional instance to populate.
   * @return {module:model/ProductAccessResponse} The populated <code>ProductAccessResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('date_renewal')) {
        obj['date_renewal'] = ApiClient.convertToType(data['date_renewal'], 'String');
      }
      if (data.hasOwnProperty('payment_method')) {
        obj['payment_method'] = ApiClient.convertToType(data['payment_method'], 'String');
      }
      if (data.hasOwnProperty('renewed')) {
        obj['renewed'] = ApiClient.convertToType(data['renewed'], 'Integer');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {String} date_renewal
   */
  exports.prototype['date_renewal'] = undefined;
  /**
   * @member {String} payment_method
   */
  exports.prototype['payment_method'] = undefined;
  /**
   * @member {Integer} renewed
   */
  exports.prototype['renewed'] = undefined;
