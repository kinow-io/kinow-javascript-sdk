...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CreateVideoStatSessionResponse = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The CreateVideoStatSessionResponse model module.
   * @module model/CreateVideoStatSessionResponse
   * @version 2.0.20
   */

  /**
   * Constructs a new <code>CreateVideoStatSessionResponse</code>.
   * @alias module:model/CreateVideoStatSessionResponse
   * @class
  ...
  /**
   * Constructs a <code>CreateVideoStatSessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateVideoStatSessionResponse} obj Optional instance to populate.
   * @return {module:model/CreateVideoStatSessionResponse} The populated <code>CreateVideoStatSessionResponse</code> instance.
   */
