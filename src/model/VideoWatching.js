...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.VideoWatching = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.VideoFreeAccess);
  }
  ...
  /**
   * The VideoWatching model module.
   * @module model/VideoWatching
   * @version 2.0.14
   */

  /**
   * Constructs a new <code>VideoWatching</code>.
   * @alias module:model/VideoWatching
   * @class
   */
  ...
  /**
   * Constructs a <code>VideoWatching</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VideoWatching} obj Optional instance to populate.
   * @return {module:model/VideoWatching} The populated <code>VideoWatching</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('watching_date')) {
        obj['watching_date'] = ApiClient.convertToType(data['watching_date'], 'String');
      }
      if (data.hasOwnProperty('watching_seek')) {
        obj['watching_seek'] = ApiClient.convertToType(data['watching_seek'], 'Integer');
      }
  ...
  /**
   * @member {String} watching_date
   */
  exports.prototype['watching_date'] = undefined;
  /**
   * @member {Integer} watching_seek
   */
  exports.prototype['watching_seek'] = undefined;
  /**
   * @member {Integer} id
   */
