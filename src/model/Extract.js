...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.Extract = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The Extract model module.
   * @module model/Extract
   * @version 1.3.42
   */

  /**
   * Constructs a new <code>Extract</code>.
   * @alias module:model/Extract
   * @class
   */
  ...
  /**
   * Constructs a <code>Extract</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Extract} obj Optional instance to populate.
   * @return {module:model/Extract} The populated <code>Extract</code> instance.
   */
