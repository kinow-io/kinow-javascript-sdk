...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('video__group_id')) {
        obj['video__group_id'] = ApiClient.convertToType(data['video__group_id'], 'Integer');
      }
   ...
   * @member {Integer} video__group_id
   */
  exports.prototype['video__group_id'] = undefined;
  /**
