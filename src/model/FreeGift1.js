...
(function(root, factory) {
   ...
   * @param idProductAttribute {Integer} Product ID attribute to offer
   ...
   */
  var exports = function(idProduct, idProductAttribute, idCustomer, firstname, lastname, email) {
    var _this = this;

    _this['id_product'] = idProduct;
    _this['id_product_attribute'] = idProductAttribute;
