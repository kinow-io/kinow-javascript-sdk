...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cover_thumbnail')) {
        obj['cover_thumbnail'] = Image.constructFromObject(data['cover_thumbnail']);
      }
  ...
  /**
   * @member {module:model/Image} cover_thumbnail
   */
  exports.prototype['cover_thumbnail'] = undefined;
  /**
