...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.VideoGroup = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The VideoGroup model module.
   * @module model/VideoGroup
   * @version 1.4.23
   */

  /**
   * Constructs a new <code>VideoGroup</code>.
   * @alias module:model/VideoGroup
   * @class
   */
  ...
  /**
   * Constructs a <code>VideoGroup</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VideoGroup} obj Optional instance to populate.
   * @return {module:model/VideoGroup} The populated <code>VideoGroup</code> instance.
   */
