...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.ActorProductRole = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.Image, root.KinowJavascriptSdk.ProductAttribute, root.KinowJavascriptSdk.ProductCategories, root.KinowJavascriptSdk.Tag);
  }
  ...
  /**
   * The ActorProductRole model module.
   * @module model/ActorProductRole
   * @version 2.0.1
   */

  /**
   * Constructs a new <code>ActorProductRole</code>.
   * @alias module:model/ActorProductRole
   * @class
   */
  ...
  /**
   * Constructs a <code>ActorProductRole</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActorProductRole} obj Optional instance to populate.
   * @return {module:model/ActorProductRole} The populated <code>ActorProductRole</code> instance.
   */
