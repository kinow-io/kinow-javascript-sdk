...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.VideoAccessInfoResponse = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The VideoAccessInfoResponse model module.
   * @module model/VideoAccessInfoResponse
   * @version 2.0.24
   */

  /**
   * Constructs a new <code>VideoAccessInfoResponse</code>.
   * @alias module:model/VideoAccessInfoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>VideoAccessInfoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VideoAccessInfoResponse} obj Optional instance to populate.
   * @return {module:model/VideoAccessInfoResponse} The populated <code>VideoAccessInfoResponse</code> instance.
   */
