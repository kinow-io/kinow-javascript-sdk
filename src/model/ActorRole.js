...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.ActorRole = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.Image);
  }
  ...
  /**
   * The ActorRole model module.
   * @module model/ActorRole
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>ActorRole</code>.
   * @alias module:model/ActorRole
   * @class
   */
  ...
  /**
   * Constructs a <code>ActorRole</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActorRole} obj Optional instance to populate.
   * @return {module:model/ActorRole} The populated <code>ActorRole</code> instance.
   */
