...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.CMSCategoryResponse = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The CMSCategoryResponse model module.
   * @module model/CMSCategoryResponse
   * @version 2.0.12
   */

  /**
   * Constructs a new <code>CMSCategoryResponse</code>.
   * @alias module:model/CMSCategoryResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CMSCategoryResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CMSCategoryResponse} obj Optional instance to populate.
   * @return {module:model/CMSCategoryResponse} The populated <code>CMSCategoryResponse</code> instance.
   */
