...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.UpdateCMSPageRequest = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The UpdateCMSPageRequest model module.
   * @module model/UpdateCMSPageRequest
   * @version 2.0.14
   */

  /**
   * Constructs a new <code>UpdateCMSPageRequest</code>.
   * @alias module:model/UpdateCMSPageRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateCMSPageRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateCMSPageRequest} obj Optional instance to populate.
   * @return {module:model/UpdateCMSPageRequest} The populated <code>UpdateCMSPageRequest</code> instance.
   */
