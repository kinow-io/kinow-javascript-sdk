...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.SessionVideoStatResponse = factory(root.KinowJavascriptSdk.ApiClient);
  }
  ...
  /**
   * The SessionVideoStatResponse model module.
   * @module model/SessionVideoStatResponse
   * @version 2.0.3
   */

  /**
   * Constructs a new <code>SessionVideoStatResponse</code>.
   * @alias module:model/SessionVideoStatResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>SessionVideoStatResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SessionVideoStatResponse} obj Optional instance to populate.
   * @return {module:model/SessionVideoStatResponse} The populated <code>SessionVideoStatResponse</code> instance.
   */
