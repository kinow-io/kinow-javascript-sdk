...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProductPriceAttribute'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProductPriceAttribute'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.ProductPrice = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.ProductPriceAttribute);
  }
}(this, function(ApiClient, ProductPriceAttribute) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes')) {
        obj['attributes'] = ApiClient.convertToType(data['attributes'], [ProductPriceAttribute]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ProductPriceAttribute>} attributes
   */
