...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ActorImages', 'model/I18nField'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ActorImages'), require('./I18nField'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.Category = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.ActorImages, root.KinowJavascriptSdk.I18nField);
  }
}(this, function(ApiClient, ActorImages, I18nField) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('images')) {
        obj['images'] = ActorImages.constructFromObject(data['images']);
      }
  ...
  /**
   * @member {module:model/ActorImages} images
   */
