...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/I18nField', 'model/WidgetSliderVideo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./I18nField'), require('./WidgetSliderVideo'));
  } else {
    // Browser globals (root is window)
    if (!root.KinowJavascriptSdk) {
      root.KinowJavascriptSdk = {};
    }
    root.KinowJavascriptSdk.WidgetSliderResponse = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField, root.KinowJavascriptSdk.WidgetSliderVideo);
  }
}(this, function(ApiClient, I18nField, WidgetSliderVideo) {
  'use strict';
  ...
  /**
   * The WidgetSliderResponse model module.
   * @module model/WidgetSliderResponse
   * @version 2.0.19
   */

  /**
   * Constructs a new <code>WidgetSliderResponse</code>.
   * @alias module:model/WidgetSliderResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>WidgetSliderResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WidgetSliderResponse} obj Optional instance to populate.
   * @return {module:model/WidgetSliderResponse} The populated <code>WidgetSliderResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('video')) {
        obj['video'] = WidgetSliderVideo.constructFromObject(data['video']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/WidgetSliderVideo} video
   */
