...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KinowJavascriptSdk.Actor1 = factory(root.KinowJavascriptSdk.ApiClient, root.KinowJavascriptSdk.I18nField);
  }
  ...
  /**
   * The Actor1 model module.
   * @module model/Actor1
   * @version 1.3.42
   */

  /**
   * Constructs a new <code>Actor1</code>.
   * @alias module:model/Actor1
   * @class
  ...
  /**
   * Constructs a <code>Actor1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Actor1} obj Optional instance to populate.
   * @return {module:model/Actor1} The populated <code>Actor1</code> instance.
   */
