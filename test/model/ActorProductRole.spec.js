...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.ActorProductRole();
  });
  ...
  describe('ActorProductRole', function() {
    it('should create an instance of ActorProductRole', function() {
      // uncomment below and update the code to test ActorProductRole
      //var instance = new KinowJavascriptSdk.ActorProductRole();
      //expect(instance).to.be.a(KinowJavascriptSdk.ActorProductRole);
    });
