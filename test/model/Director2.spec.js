...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.Director2();
  });
  ...
  describe('Director2', function() {
    it('should create an instance of Director2', function() {
      // uncomment below and update the code to test Director2
      //var instance = new KinowJavascriptSdk.Director2();
      //expect(instance).to.be.a(KinowJavascriptSdk.Director2);
    });
