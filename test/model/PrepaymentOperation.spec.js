...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.PrepaymentOperation();
  });
  ...
  describe('PrepaymentOperation', function() {
    it('should create an instance of PrepaymentOperation', function() {
      // uncomment below and update the code to test PrepaymentOperation
      //var instance = new KinowJavascriptSdk.PrepaymentOperation();
      //expect(instance).to.be.a(KinowJavascriptSdk.PrepaymentOperation);
    });
