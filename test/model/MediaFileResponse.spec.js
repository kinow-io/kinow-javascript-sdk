...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.MediaFileResponse();
  });
  ...
  describe('MediaFileResponse', function() {
    it('should create an instance of MediaFileResponse', function() {
      // uncomment below and update the code to test MediaFileResponse
      //var instance = new KinowJavascriptSdk.MediaFileResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.MediaFileResponse);
    });
