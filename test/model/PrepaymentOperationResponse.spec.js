...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.PrepaymentOperationResponse();
  });
  ...
  describe('PrepaymentOperationResponse', function() {
    it('should create an instance of PrepaymentOperationResponse', function() {
      // uncomment below and update the code to test PrepaymentOperationResponse
      //var instance = new KinowJavascriptSdk.PrepaymentOperationResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.PrepaymentOperationResponse);
    });
