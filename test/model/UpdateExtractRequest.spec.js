...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.UpdateExtractRequest();
  });
  ...
  describe('UpdateExtractRequest', function() {
    it('should create an instance of UpdateExtractRequest', function() {
      // uncomment below and update the code to test UpdateExtractRequest
      //var instance = new KinowJavascriptSdk.UpdateExtractRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.UpdateExtractRequest);
    });
