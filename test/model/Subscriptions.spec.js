...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.Subscriptions();
  });
  ...
  describe('Subscriptions', function() {
    it('should create an instance of Subscriptions', function() {
      ...
      //var instance = new KinowJavascriptSdk.Subscriptions();
      //expect(instance).to.be.a(KinowJavascriptSdk.Subscriptions);
    });
