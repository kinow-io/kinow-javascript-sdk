...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.Gift3();
  });
  ...
  describe('Gift3', function() {
    it('should create an instance of Gift3', function() {
      // uncomment below and update the code to test Gift3
      //var instance = new KinowJavascriptSdk.Gift3();
      //expect(instance).to.be.a(KinowJavascriptSdk.Gift3);
    });
