...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.VideoStat();
  });
  ...
  describe('VideoStat', function() {
    it('should create an instance of VideoStat', function() {
      // uncomment below and update the code to test VideoStat
      //var instance = new KinowJavascriptSdk.VideoStat();
      //expect(instance).to.be.a(KinowJavascriptSdk.VideoStat);
    });
