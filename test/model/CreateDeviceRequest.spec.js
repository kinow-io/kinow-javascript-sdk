...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateDeviceRequest();
  });
  ...
  describe('CreateDeviceRequest', function() {
    it('should create an instance of CreateDeviceRequest', function() {
      ...
      //var instance = new KinowJavascriptSdk.CreateDeviceRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateDeviceRequest);
    });
