...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateCMSCategoryRequest();
  });
  ...
  describe('CreateCMSCategoryRequest', function() {
    it('should create an instance of CreateCMSCategoryRequest', function() {
      // uncomment below and update the code to test CreateCMSCategoryRequest
      //var instance = new KinowJavascriptSdk.CreateCMSCategoryRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateCMSCategoryRequest);
    });
