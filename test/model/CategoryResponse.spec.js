...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CategoryResponse();
  });
  ...
  describe('CategoryResponse', function() {
    it('should create an instance of CategoryResponse', function() {
      // uncomment below and update the code to test CategoryResponse
      //var instance = new KinowJavascriptSdk.CategoryResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.CategoryResponse);
    });
