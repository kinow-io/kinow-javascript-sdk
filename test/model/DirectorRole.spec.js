...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.DirectorRole();
  });
  ...
  describe('DirectorRole', function() {
    it('should create an instance of DirectorRole', function() {
      // uncomment below and update the code to test DirectorRole
      //var instance = new KinowJavascriptSdk.DirectorRole();
      //expect(instance).to.be.a(KinowJavascriptSdk.DirectorRole);
    });
