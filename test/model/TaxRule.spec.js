...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.TaxRule();
  });
  ...
  describe('TaxRule', function() {
    it('should create an instance of TaxRule', function() {
      // uncomment below and update the code to test TaxRule
      //var instance = new KinowJavascriptSdk.TaxRule();
      //expect(instance).to.be.a(KinowJavascriptSdk.TaxRule);
    });
