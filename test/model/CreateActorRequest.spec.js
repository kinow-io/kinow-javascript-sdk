...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateActorRequest();
  });
  ...
  describe('CreateActorRequest', function() {
    it('should create an instance of CreateActorRequest', function() {
      // uncomment below and update the code to test CreateActorRequest
      //var instance = new KinowJavascriptSdk.CreateActorRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateActorRequest);
    });
