...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.Player1();
  });
  ...
  describe('Player1', function() {
    it('should create an instance of Player1', function() {
      // uncomment below and update the code to test Player1
      //var instance = new KinowJavascriptSdk.Player1();
      //expect(instance).to.be.a(KinowJavascriptSdk.Player1);
    });
