...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.GeolocSettings();
  });
  ...
  describe('GeolocSettings', function() {
    it('should create an instance of GeolocSettings', function() {
      // uncomment below and update the code to test GeolocSettings
      //var instance = new KinowJavascriptSdk.GeolocSettings();
      //expect(instance).to.be.a(KinowJavascriptSdk.GeolocSettings);
    });
