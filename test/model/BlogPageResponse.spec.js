...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.BlogPageResponse();
  });
  ...
  describe('BlogPageResponse', function() {
    it('should create an instance of BlogPageResponse', function() {
      // uncomment below and update the code to test BlogPageResponse
      //var instance = new KinowJavascriptSdk.BlogPageResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.BlogPageResponse);
    });
