...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateCartRequest();
  });
  ...
  describe('CreateCartRequest', function() {
    it('should create an instance of CreateCartRequest', function() {
      // uncomment below and update the code to test CreateCartRequest
      //var instance = new KinowJavascriptSdk.CreateCartRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateCartRequest);
    });
