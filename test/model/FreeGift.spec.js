...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.FreeGift();
  });
  ...
  describe('FreeGift', function() {
    it('should create an instance of FreeGift', function() {
      // uncomment below and update the code to test FreeGift
      //var instance = new KinowJavascriptSdk.FreeGift();
      //expect(instance).to.be.a(KinowJavascriptSdk.FreeGift);
    });
