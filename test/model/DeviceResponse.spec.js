...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.DeviceResponse();
  });
  ...
  describe('DeviceResponse', function() {
    it('should create an instance of DeviceResponse', function() {
      ...
      //var instance = new KinowJavascriptSdk.DeviceResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.DeviceResponse);
    });
