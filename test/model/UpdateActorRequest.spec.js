...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.UpdateActorRequest();
  });
  ...
  describe('UpdateActorRequest', function() {
    it('should create an instance of UpdateActorRequest', function() {
      // uncomment below and update the code to test UpdateActorRequest
      //var instance = new KinowJavascriptSdk.UpdateActorRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.UpdateActorRequest);
    });
