...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateCustomerRequest();
  });
  ...
  describe('CreateCustomerRequest', function() {
    it('should create an instance of CreateCustomerRequest', function() {
      ...
      //var instance = new KinowJavascriptSdk.CreateCustomerRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateCustomerRequest);
    });
