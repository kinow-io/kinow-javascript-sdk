...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.UpdateProductRequest();
  });
  ...
  describe('UpdateProductRequest', function() {
    it('should create an instance of UpdateProductRequest', function() {
      ...
      //var instance = new KinowJavascriptSdk.UpdateProductRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.UpdateProductRequest);
    });
