...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CartProduct();
  });
  ...
  describe('CartProduct', function() {
    it('should create an instance of CartProduct', function() {
      // uncomment below and update the code to test CartProduct
      //var instance = new KinowJavascriptSdk.CartProduct();
      //expect(instance).to.be.a(KinowJavascriptSdk.CartProduct);
    });

    it('should have the property idGift (base name: "id_gift")', function() {
      // uncomment below and update the code to test the property idGift
      //var instance = new KinowJavascriptSdk.CartProduct();
