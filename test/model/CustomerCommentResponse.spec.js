...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CustomerCommentResponse();
  });
  ...
  describe('CustomerCommentResponse', function() {
    it('should create an instance of CustomerCommentResponse', function() {
      // uncomment below and update the code to test CustomerCommentResponse
      //var instance = new KinowJavascriptSdk.CustomerCommentResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.CustomerCommentResponse);
    });
