...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.PrepaymentBonusResponse();
  });
  ...
  describe('PrepaymentBonusResponse', function() {
    it('should create an instance of PrepaymentBonusResponse', function() {
      // uncomment below and update the code to test PrepaymentBonusResponse
      //var instance = new KinowJavascriptSdk.PrepaymentBonusResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.PrepaymentBonusResponse);
    });
