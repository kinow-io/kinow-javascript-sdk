...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateCartRuleRequest();
  });
  ...
  describe('CreateCartRuleRequest', function() {
    it('should create an instance of CreateCartRuleRequest', function() {
      // uncomment below and update the code to test CreateCartRuleRequest
      //var instance = new KinowJavascriptSdk.CreateCartRuleRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateCartRuleRequest);
    });
