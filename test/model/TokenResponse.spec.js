...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.TokenResponse();
  });
  ...
  describe('TokenResponse', function() {
    it('should create an instance of TokenResponse', function() {
      ...
      //var instance = new KinowJavascriptSdk.TokenResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.TokenResponse);
    });
