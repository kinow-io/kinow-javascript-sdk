...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CMSCategory();
  });
  ...
  describe('CMSCategory', function() {
    it('should create an instance of CMSCategory', function() {
      // uncomment below and update the code to test CMSCategory
      //var instance = new KinowJavascriptSdk.CMSCategory();
      //expect(instance).to.be.a(KinowJavascriptSdk.CMSCategory);
    });
