...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.Director1();
  });
  ...
  describe('Director1', function() {
    it('should create an instance of Director1', function() {
      // uncomment below and update the code to test Director1
      //var instance = new KinowJavascriptSdk.Director1();
      //expect(instance).to.be.a(KinowJavascriptSdk.Director1);
    });
