...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.SessionVideoStatResponse();
  });
  ...
  describe('SessionVideoStatResponse', function() {
    it('should create an instance of SessionVideoStatResponse', function() {
      // uncomment below and update the code to test SessionVideoStatResponse
      //var instance = new KinowJavascriptSdk.SessionVideoStatResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.SessionVideoStatResponse);
    });
