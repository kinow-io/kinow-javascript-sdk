...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.ProductAttributeCreateRequest1();
  });
  ...
  describe('ProductAttributeCreateRequest1', function() {
    it('should create an instance of ProductAttributeCreateRequest1', function() {
      // uncomment below and update the code to test ProductAttributeCreateRequest1
      //var instance = new KinowJavascriptSdk.ProductAttributeCreateRequest1();
      //expect(instance).to.be.a(KinowJavascriptSdk.ProductAttributeCreateRequest1);
    });
