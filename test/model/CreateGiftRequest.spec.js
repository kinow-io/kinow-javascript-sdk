...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateGiftRequest();
  });
  ...
  describe('CreateGiftRequest', function() {
    it('should create an instance of CreateGiftRequest', function() {
      // uncomment below and update the code to test CreateGiftRequest
      //var instance = new KinowJavascriptSdk.CreateGiftRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateGiftRequest);
    });
    ...
    it('should have the property autoLink (base name: "auto_link")', function() {
      // uncomment below and update the code to test the property autoLink
      //var instance = new KinowJavascriptSdk.CreateGiftRequest();
      //expect(instance).to.be();
    });
