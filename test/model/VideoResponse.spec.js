...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.VideoResponse();
  });
  ...
  describe('VideoResponse', function() {
    it('should create an instance of VideoResponse', function() {
      ...
      //var instance = new KinowJavascriptSdk.VideoResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.VideoResponse);
    });
