...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.UpdateCartRequest();
  });
  ...
  describe('UpdateCartRequest', function() {
    it('should create an instance of UpdateCartRequest', function() {
      // uncomment below and update the code to test UpdateCartRequest
      //var instance = new KinowJavascriptSdk.UpdateCartRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.UpdateCartRequest);
    });
