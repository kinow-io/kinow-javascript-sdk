...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CartPriceResponse();
  });
  ...
  describe('CartPriceResponse', function() {
    it('should create an instance of CartPriceResponse', function() {
      // uncomment below and update the code to test CartPriceResponse
      //var instance = new KinowJavascriptSdk.CartPriceResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.CartPriceResponse);
    });
