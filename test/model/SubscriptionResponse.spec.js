...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.SubscriptionResponse();
  });
  ...
  describe('SubscriptionResponse', function() {
    it('should create an instance of SubscriptionResponse', function() {
      ...
      //var instance = new KinowJavascriptSdk.SubscriptionResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.SubscriptionResponse);
    });
