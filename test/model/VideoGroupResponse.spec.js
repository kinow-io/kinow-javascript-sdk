...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.VideoGroupResponse();
  });
  ...
  describe('VideoGroupResponse', function() {
    it('should create an instance of VideoGroupResponse', function() {
      // uncomment below and update the code to test VideoGroupResponse
      //var instance = new KinowJavascriptSdk.VideoGroupResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.VideoGroupResponse);
    });
