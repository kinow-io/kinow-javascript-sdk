...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CMSPageResponse();
  });
  ...
  describe('CMSPageResponse', function() {
    it('should create an instance of CMSPageResponse', function() {
      // uncomment below and update the code to test CMSPageResponse
      //var instance = new KinowJavascriptSdk.CMSPageResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.CMSPageResponse);
    });
