...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.DirectorProduct();
  });
  ...
  describe('DirectorProduct', function() {
    it('should create an instance of DirectorProduct', function() {
      // uncomment below and update the code to test DirectorProduct
      //var instance = new KinowJavascriptSdk.DirectorProduct();
      //expect(instance).to.be.a(KinowJavascriptSdk.DirectorProduct);
    });
