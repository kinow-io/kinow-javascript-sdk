...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateVideoStatSessionRequest();
  });
  ...
  describe('CreateVideoStatSessionRequest', function() {
    it('should create an instance of CreateVideoStatSessionRequest', function() {
      // uncomment below and update the code to test CreateVideoStatSessionRequest
      //var instance = new KinowJavascriptSdk.CreateVideoStatSessionRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateVideoStatSessionRequest);
    });
