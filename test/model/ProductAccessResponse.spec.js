...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.ProductAccessResponse();
  });
  ...
  describe('ProductAccessResponse', function() {
    it('should create an instance of ProductAccessResponse', function() {
      // uncomment below and update the code to test ProductAccessResponse
      //var instance = new KinowJavascriptSdk.ProductAccessResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.ProductAccessResponse);
    });
