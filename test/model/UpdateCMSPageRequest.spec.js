...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.UpdateCMSPageRequest();
  });
  ...
  describe('UpdateCMSPageRequest', function() {
    it('should create an instance of UpdateCMSPageRequest', function() {
      // uncomment below and update the code to test UpdateCMSPageRequest
      //var instance = new KinowJavascriptSdk.UpdateCMSPageRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.UpdateCMSPageRequest);
    });
