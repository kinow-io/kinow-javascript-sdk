...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateDirectorRequest();
  });
  ...
  describe('CreateDirectorRequest', function() {
    it('should create an instance of CreateDirectorRequest', function() {
      // uncomment below and update the code to test CreateDirectorRequest
      //var instance = new KinowJavascriptSdk.CreateDirectorRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateDirectorRequest);
    });
