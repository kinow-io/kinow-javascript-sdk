...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.UpdateVideoRequest();
  });
  ...
  describe('UpdateVideoRequest', function() {
    it('should create an instance of UpdateVideoRequest', function() {
      // uncomment below and update the code to test UpdateVideoRequest
      //var instance = new KinowJavascriptSdk.UpdateVideoRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.UpdateVideoRequest);
    });
