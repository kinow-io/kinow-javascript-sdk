...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.ExtractResponse();
  });
  ...
  describe('ExtractResponse', function() {
    it('should create an instance of ExtractResponse', function() {
      // uncomment below and update the code to test ExtractResponse
      //var instance = new KinowJavascriptSdk.ExtractResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.ExtractResponse);
    });
