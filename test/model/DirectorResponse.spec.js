...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.DirectorResponse();
  });
  ...
  describe('DirectorResponse', function() {
    it('should create an instance of DirectorResponse', function() {
      // uncomment below and update the code to test DirectorResponse
      //var instance = new KinowJavascriptSdk.DirectorResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.DirectorResponse);
    });
