...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.DirectorProductRole();
  });
  ...
  describe('DirectorProductRole', function() {
    it('should create an instance of DirectorProductRole', function() {
      // uncomment below and update the code to test DirectorProductRole
      //var instance = new KinowJavascriptSdk.DirectorProductRole();
      //expect(instance).to.be.a(KinowJavascriptSdk.DirectorProductRole);
    });
