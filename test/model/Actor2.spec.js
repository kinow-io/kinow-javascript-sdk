...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.Actor2();
  });
  ...
  describe('Actor2', function() {
    it('should create an instance of Actor2', function() {
      // uncomment below and update the code to test Actor2
      //var instance = new KinowJavascriptSdk.Actor2();
      //expect(instance).to.be.a(KinowJavascriptSdk.Actor2);
    });
