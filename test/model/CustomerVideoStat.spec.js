...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CustomerVideoStat();
  });
  ...
  describe('CustomerVideoStat', function() {
    it('should create an instance of CustomerVideoStat', function() {
      // uncomment below and update the code to test CustomerVideoStat
      //var instance = new KinowJavascriptSdk.CustomerVideoStat();
      //expect(instance).to.be.a(KinowJavascriptSdk.CustomerVideoStat);
    });
