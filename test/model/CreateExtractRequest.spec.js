...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateExtractRequest();
  });
  ...
  describe('CreateExtractRequest', function() {
    it('should create an instance of CreateExtractRequest', function() {
      // uncomment below and update the code to test CreateExtractRequest
      //var instance = new KinowJavascriptSdk.CreateExtractRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateExtractRequest);
    });
