...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.CreateGroupRequest();
  });
  ...
  describe('CreateGroupRequest', function() {
    it('should create an instance of CreateGroupRequest', function() {
      ...
      //var instance = new KinowJavascriptSdk.CreateGroupRequest();
      //expect(instance).to.be.a(KinowJavascriptSdk.CreateGroupRequest);
    });
