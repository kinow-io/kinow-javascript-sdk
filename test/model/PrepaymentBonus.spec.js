...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.PrepaymentBonus();
  });
  ...
  describe('PrepaymentBonus', function() {
    it('should create an instance of PrepaymentBonus', function() {
      // uncomment below and update the code to test PrepaymentBonus
      //var instance = new KinowJavascriptSdk.PrepaymentBonus();
      //expect(instance).to.be.a(KinowJavascriptSdk.PrepaymentBonus);
    });
