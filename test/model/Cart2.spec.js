...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.Cart2();
  });
  ...
  describe('Cart2', function() {
    it('should create an instance of Cart2', function() {
      // uncomment below and update the code to test Cart2
      //var instance = new KinowJavascriptSdk.Cart2();
      //expect(instance).to.be.a(KinowJavascriptSdk.Cart2);
    });
