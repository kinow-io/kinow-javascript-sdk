...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.ActorRole();
  });
  ...
  describe('ActorRole', function() {
    it('should create an instance of ActorRole', function() {
      // uncomment below and update the code to test ActorRole
      //var instance = new KinowJavascriptSdk.ActorRole();
      //expect(instance).to.be.a(KinowJavascriptSdk.ActorRole);
    });
