...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.VideoWatching();
  });
  ...
  describe('VideoWatching', function() {
    it('should create an instance of VideoWatching', function() {
      // uncomment below and update the code to test VideoWatching
      //var instance = new KinowJavascriptSdk.VideoWatching();
      //expect(instance).to.be.a(KinowJavascriptSdk.VideoWatching);
    });

    it('should have the property watchingDate (base name: "watching_date")', function() {
      // uncomment below and update the code to test the property watchingDate
      //var instance = new KinowJavascriptSdk.VideoWatching();
      //expect(instance).to.be();
    });

    it('should have the property watchingSeek (base name: "watching_seek")', function() {
      // uncomment below and update the code to test the property watchingSeek
      //var instance = new KinowJavascriptSdk.VideoWatching();
      //expect(instance).to.be();
    });
