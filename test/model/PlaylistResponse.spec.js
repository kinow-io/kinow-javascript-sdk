...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.PlaylistResponse();
  });
  ...
  describe('PlaylistResponse', function() {
    it('should create an instance of PlaylistResponse', function() {
      ...
      //var instance = new KinowJavascriptSdk.PlaylistResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.PlaylistResponse);
    });
