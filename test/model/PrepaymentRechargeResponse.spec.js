...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KinowJavascriptSdk.PrepaymentRechargeResponse();
  });
  ...
  describe('PrepaymentRechargeResponse', function() {
    it('should create an instance of PrepaymentRechargeResponse', function() {
      // uncomment below and update the code to test PrepaymentRechargeResponse
      //var instance = new KinowJavascriptSdk.PrepaymentRechargeResponse();
      //expect(instance).to.be.a(KinowJavascriptSdk.PrepaymentRechargeResponse);
    });
