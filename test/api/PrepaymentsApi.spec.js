...
(function(root, factory) {
  ...
  describe('PrepaymentsApi', function() {
    describe('getPrepaymentBalances', function() {
      it('should call getPrepaymentBalances successfully', function(done) {
        //uncomment below and update the code to test getPrepaymentBalances
        //instance.getPrepaymentBalances(function(error) {
    ...
    describe('getPrepaymentBonus_0', function() {
      it('should call getPrepaymentBonus_0 successfully', function(done) {
        //uncomment below and update the code to test getPrepaymentBonus_0
        //instance.getPrepaymentBonus_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
