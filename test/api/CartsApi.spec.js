...
(function(root, factory) {
  ...
  describe('CartsApi', function() {
    ...
    describe('removeProductFromCart', function() {
      it('should call removeProductFromCart successfully', function(done) {
        //uncomment below and update the code to test removeProductFromCart
        //instance.removeProductFromCart(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
