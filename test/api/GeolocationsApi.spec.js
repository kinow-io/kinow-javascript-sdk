...
(function(root, factory) {
  ...
  describe('GeolocationsApi', function() {
    describe('getGeolocSettings', function() {
      it('should call getGeolocSettings successfully', function(done) {
        //uncomment below and update the code to test getGeolocSettings
        //instance.getGeolocSettings(function(error) {
