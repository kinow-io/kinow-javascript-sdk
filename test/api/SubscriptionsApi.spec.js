...
(function(root, factory) {
  ...
  describe('SubscriptionsApi', function() {
    describe('attachCategoriesToSubscription', function() {
      it('should call attachCategoriesToSubscription successfully', function(done) {
        //uncomment below and update the code to test attachCategoriesToSubscription
        //instance.attachCategoriesToSubscription(function(error) {
    ...
    describe('detachCategoryFromSubscription', function() {
      it('should call detachCategoryFromSubscription successfully', function(done) {
        //uncomment below and update the code to test detachCategoryFromSubscription
        //instance.detachCategoryFromSubscription(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
