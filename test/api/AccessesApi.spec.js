...
(function(root, factory) {
  ...
  describe('AccessesApi', function() {
    describe('getAvailableCategories', function() {
      it('should call getAvailableCategories successfully', function(done) {
        //uncomment below and update the code to test getAvailableCategories
        //instance.getAvailableCategories(function(error) {
