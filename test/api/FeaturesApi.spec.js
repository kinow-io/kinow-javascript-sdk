...
(function(root, factory) {
  ...
  describe('FeaturesApi', function() {
    ...
    describe('getActorFeatures', function() {
      it('should call getActorFeatures successfully', function(done) {
        //uncomment below and update the code to test getActorFeatures
        //instance.getActorFeatures(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getDirectorFeatures', function() {
      it('should call getDirectorFeatures successfully', function(done) {
        //uncomment below and update the code to test getDirectorFeatures
        //instance.getDirectorFeatures(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
