...
(function(root, factory) {
  ...
  describe('GroupsApi', function() {
    ...
    describe('getGroupCustomers', function() {
      it('should call getGroupCustomers successfully', function(done) {
        //uncomment below and update the code to test getGroupCustomers
        //instance.getGroupCustomers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
