...
(function(root, factory) {
  ...
  describe('GiftsApi', function() {
    ...
    describe('getGiftsInCart', function() {
      it('should call getGiftsInCart successfully', function(done) {
        //uncomment below and update the code to test getGiftsInCart
        //instance.getGiftsInCart(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
