...
(function(root, factory) {
  ...
  describe('GiftsApi', function() {
    ...
    describe('getGiftByToken', function() {
      it('should call getGiftByToken successfully', function(done) {
        //uncomment below and update the code to test getGiftByToken
        //instance.getGiftByToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
