...
(function(root, factory) {
  ...
  describe('ProductsApi', function() {
    ...
    describe('attachProductToDirector_0', function() {
      it('should call attachProductToDirector_0 successfully', function(done) {
        //uncomment below and update the code to test attachProductToDirector_0
        //instance.attachProductToDirector_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
