...
(function(root, factory) {
  ...
  describe('ImagesApi', function() {
    ...
    describe('getManufacturerCoverImage', function() {
      it('should call getManufacturerCoverImage successfully', function(done) {
        //uncomment below and update the code to test getManufacturerCoverImage
        //instance.getManufacturerCoverImage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSupplierCoverImage', function() {
      it('should call getSupplierCoverImage successfully', function(done) {
        //uncomment below and update the code to test getSupplierCoverImage
        //instance.getSupplierCoverImage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadProductScreenshot_0', function() {
      it('should call uploadProductScreenshot_0 successfully', function(done) {
        //uncomment below and update the code to test uploadProductScreenshot_0
        //instance.uploadProductScreenshot_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
