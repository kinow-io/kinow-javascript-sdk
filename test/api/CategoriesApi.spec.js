...
(function(root, factory) {
  ...
  describe('CategoriesApi', function() {
    ...
    describe('getCategoryThumbnail', function() {
      it('should call getCategoryThumbnail successfully', function(done) {
        //uncomment below and update the code to test getCategoryThumbnail
        //instance.getCategoryThumbnail(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
