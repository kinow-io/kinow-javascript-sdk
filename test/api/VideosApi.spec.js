...
(function(root, factory) {
  ...
  describe('VideosApi', function() {
    ...
    describe('getPlayerIframe', function() {
      it('should call getPlayerIframe successfully', function(done) {
        //uncomment below and update the code to test getPlayerIframe
        //instance.getPlayerIframe(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getVideoGeolocation_0', function() {
      it('should call getVideoGeolocation_0 successfully', function(done) {
        //uncomment below and update the code to test getVideoGeolocation_0
        //instance.getVideoGeolocation_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getVideoPlayerUrl', function() {
      it('should call getVideoPlayerUrl successfully', function(done) {
        //uncomment below and update the code to test getVideoPlayerUrl
        //instance.getVideoPlayerUrl(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
