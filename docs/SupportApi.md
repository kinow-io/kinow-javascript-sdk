...
# **createMessage**
> SupportResponse createMessage(body)
...
var body = new KinowJavascriptSdk.CreateMessageRequest(); // CreateMessageRequest | Message parameters
...
------------- | ------------- | ------------- | -------------
 **body** | [**CreateMessageRequest**](CreateMessageRequest.md)| Message parameters | 
...
# **getContacts**
> ContactListResponse getContacts(opts)
