...
[**getGroupCustomers**](GroupsApi.md#getGroupCustomers) | **GET** /groups/{group_id}/customers | 
...
<a name="getGroupCustomers"></a>
# **getGroupCustomers**
> CustomerListResponse getGroupCustomers(groupId, opts)
...
apiInstance.getGroupCustomers(groupId, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
